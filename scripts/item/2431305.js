...
//超能力者部分
        case 14200:
            im.gainItem(1262000, 1);//10
            im.gainItem(1353200, 1);//10副手
            break;
        case 14210:
            im.gainItem(1262001, 1);//30
            //im.gainItem(1353201, 1);//30副手
            break;
        case 14211:
            im.gainItem(1262003, 1);//60
            //im.gainItem(1353202, 1);//60副手
            break;
        case 14212:
            im.gainItem(1262007, 1);//100
            //im.gainItem(1353203, 1);//100副手
            //im.gainItem(1353205, 1);//140
            break;
    }
}
/*
