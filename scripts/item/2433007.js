...
//itemid,概率,数量 概率为10表示必暴，每次打开箱子只取一个元素
        ...
        Array(2049137, 10, 5),
        Array(4310058, 10, 5), // 暴君B
        Array(4310058, 5, 10), // 暴君B
        Array(4310058, 7, 10), // 暴君B
	Array(4310156, 10, 2), //埃苏莱布斯币
	Array(4310119, 10, 5), //11周年币
	Array(4310143, 10, 5), //BOSS币
	Array(4310156, 1, 5), //埃苏莱布斯币
	Array(4310119, 7, 6), //11周年币
	Array(4310143, 6, 10), //BOSS币
	Array(4001839, 10, 100),//星星
        //Array(2613000, 9, 1), // 星火单手武器攻击力卷轴 - 为单手武器附加提升攻击力的属性。
        //Array(2613001, 9, 1), // 星火单手武器魔法力卷轴 - 为单手武器附加提升魔力的属性。
       // Array(2612010, 9, 1), // 星火双手武器攻击力卷轴 - 为双手武器附加提升攻击力的属性。
        Array(2049323, 10, 2), //无损
        Array(2046913, 6, 1), // 宿命正义单手武器攻击力卷轴 100% // 为单手武器增加攻击力属性。
        Array(2046914, 6, 1), // 宿命正义单手武器魔力卷轴 100% // 为单手武器增加魔法攻击力属性。
        Array(2046173, 6, 1), // 宿命正义双手武器攻击力卷轴 100% // 为双手武器增加攻击力属性。
        Array(2046577, 6, 1), // 宿命正义防具力量卷轴 100% // 为防具增加力量属性。
        Array(2046578, 6, 1), // 宿命正义防具智力卷轴 100% // 为防具增加智力属性。
        Array(2046579, 6, 1), // 宿命正义防具敏捷卷轴 100% // 为防具增加敏捷属性。
        Array(2046580, 6, 1), // 宿命正义防具运气卷轴 100% // 为防具增加运气属性。
        Array(2046763, 1, 1), // 宿命正义饰品力量卷轴 100% // 为饰品增加力量属性。
        Array(2046764, 1, 1), // 宿命正义饰品智力卷轴 100% // 为饰品增加智力属性。
        Array(2046765, 1, 1), // 宿命正义饰品敏捷卷轴 100% // 为饰品增加敏捷属性。
        Array(2046766, 1, 1) // 宿命正义饰品运气卷轴 100% // 为饰品增加运气属性。
        );
...
var EquipList = Array(
        Array(1102471, 4, 1), // 赫里希安精锐战士披风 // (无描述)
        Array(1102472, 5, 1), // 赫里希安精锐法师披风 // (无描述)
        Array(1102473, 6, 1), // 赫里希安精锐弓箭手披风 // (无描述)
        Array(1102474, 7, 1), // 赫里希安精锐飞侠披风 // (无描述)
        Array(1102475, 8, 1), // 赫里希安精锐海盗披风 // (无描述)
        Array(1072732, 9, 1), // 赫里希安精锐战士靴 // (无描述)
        Array(1072733, 1, 1), // 赫里希安精锐法师靴 // (无描述)
        Array(1072734, 2, 1), // 赫里希安精锐弓箭手靴 // (无描述)
        Array(1072735, 3, 1), // 赫里希安精锐飞侠靴 // (无描述)
        Array(1072736, 4, 1), // 赫里希安精锐海盗靴 // (无描述)
        Array(1132164, 5, 1), // 赫里希安精锐战士腰带 // (无描述)
        Array(1132165, 6, 1), // 赫里希安精锐法师腰带 // (无描述)
        Array(1132166, 7, 1), // 赫里希安精锐弓箭手腰带 // (无描述)
        Array(1132167, 8, 1), // 赫里希安精锐飞侠腰带 // (无描述)
        Array(1132168, 9, 1) // 赫里希安精锐海盗腰带 // (无描述)
       /* Array(1004422, 10, 1), //埃苏莱布斯核心帽, 10, 1),//(战士)
        ...
        Array(1212115, 10, 1), //埃苏莱布斯魔力源泉杖, 10, 1),//(夜光法师)
        Array(1222109, 10, 1), //埃苏莱布斯天使手铳, 10, 1),//(天使)
        Array(1232109, 10, 1), //埃苏莱布斯死亡使者, 10, 1),//(复仇者)
        Array(1242116, 10, 1), //埃苏莱布斯精神之刃, 10, 1),//(尖兵)
        Array(1302333, 10, 1), //埃苏莱布斯银槲之剑, 10, 1),//(单手剑)
        Array(1312199, 10, 1), //埃苏莱布斯双刃切肉斧, 10, 1),//(单手斧头)
        Array(1332274, 10, 1), //埃苏莱布斯大马士革剑, 10, 1),//(飞侠短刀)
        Array(1322250, 10, 1), //埃苏莱布斯戈耳迪锤, 10, 1),//(恶魔猎手)
        Array(1342101, 10, 1), //埃苏莱布斯急速之刃, 10, 1),//(双刀副手)
        Array(1362135, 10, 1), //埃苏莱布斯洞察手杖, 10, 1),//(幻影)
        Array(1372222, 10, 1), //埃苏莱布斯魔力夺取者, 10, 1),//(短杖)
        Array(1382259, 10, 1), //埃苏莱布斯魔冠之杖, 10, 1),//(长杖)
        Array(1402251, 10, 1), //埃苏莱布斯忏悔之剑, 10, 1),//(双手剑)
        Array(1412177, 10, 1), //埃苏莱布斯战斗切肉斧, 10, 1),//(双手斧头)
        Array(1422184, 10, 1), //埃苏莱布斯闪电锤, 10, 1),//(双手钝器)
        Array(1432214, 10, 1), //埃苏莱布斯贯雷枪, 10, 1),//(战士 枪 )
        Array(1442268, 10, 1), //埃苏莱布斯半月宽刃斧, 10, 1),//(战士 矛)
        Array(1452252, 10, 1), //埃苏莱布斯追风者, 10, 1),//(弓)
        Array(1462239, 10, 1), //埃苏莱布斯风翼弩, 10, 1),//(弩)
        Array(1472261, 10, 1), //埃苏莱布斯危险之手, 10, 1),//(飞侠拳套)
        Array(1482216, 10, 1), //埃苏莱布斯巨狼之爪, 10, 1),//(海盗指节)
        Array(1492231, 10, 1), //埃苏莱布斯左轮枪, 10, 1),//(海盗手枪)
        Array(1522138, 10, 1), //埃苏莱布斯双风翼弩, 10, 1),//(双弩精灵)
        Array(1532144, 10, 1), //埃苏莱布斯荣耀炮, 10, 1),//(火炮手)
        Array(1532144, 10, 1), //埃苏莱布斯荣耀炮, 10, 1),//(火炮手)
