/*function start() {
	...
	var toDrop = ii.randomizeStats(ii.getEquipById(1142796).copy(); // 生成一个Equip类1142796
...
function start() {
        im.gainItem(2432304, -1);
	var ii = im.getItemInfo();					
	var toDrop = ii.randomizeStats(ii.getEquipById(1142796)).copy(); // 生成一个Equip类1142574
