...
// ------ 特殊 ------
Array(5064300, 200, 1, 3), //卷轴防护卷轴
Array(5062500, 500, 1, 3), //大师附加神奇魔方
Array(5062000, 500, 1, 3), //神奇魔方
Array(5064000, 100, 1, 3), //防爆卷轴
Array(5064100, 100, 1, 3), //保护卷轴
Array(5062002, 500, 2, 3),  //高级神奇魔方
Array(5062010, 500, 2, 3),  //高级神奇魔方
Array(5062009, 500, 2, 3),  //高级神奇魔方
Array(2340000, 300, 1, 3), //祝福卷轴
Array(5062009, 600, 1, 3), //魔方
Array(5064000, 50, 1, 3),//防爆卷
//Array(2049124, 50, 1, 3),//正向
Array(4001714, 200, 1, 3), //100W金币
Array(2049135, 100, 1, 3), //惊人正义混沌卷轴 20%
Array(2049752, 20, 1, 3), //S级潜能卷轴 30%
Array(2049750, 10, 1, 3), //S级80%
Array(2049704, 200, 1, 3), //A级潜能附加卷轴 40%
Array(2049300, 100, 1, 3), 
Array(2049135, 50, 1, 3),
Array(2049136, 50, 1, 3),
Array(2049137, 50, 1, 3),
Array(2049124, 100, 3, 3),
...
function action(mode, type, selection) {
    ...
    if (status == 0) {
        ...
        if (finalitem.length != 0) {
            ...
            item = im.gainGachaponItem(itemId, quantity, "雪花宝箱", notice);
            if (item != -1) {
				im.gainItem(2430217, -1);
				im.gainItem(4001839, 10);
