...
function action(mode, type, selection) {
    ...
    if (im.getMapId() == 180000001) {
		...
		var selStr = "#r[提示]： #e#b请选择您需要的革命武器，只能领取1件哦：#k#n\r\n\r\n#r[务必注意]:#b暂时不领取请点击停止对话\r\n\r\n";
	...
	//if (im.getSpace(2) >= 1) {
		...
		im.gainItem(1222079, 1);//革命双头杖
		im.sendOk("获得了 #z1222079# x 1");
		im.worldSpouseMessage(0x24,"『革命武器箱』：玩家 "+ im.getChar().getName() +" 获得了革命双头杖。");	
		im.dispose();
	} else {
	...
	case 1:
           if (im.getLevel() >= 100 && im.getPlayerPoints() > 30) {
		im.gainItem(2432068, -1);
		im.gainItem(1222074, 1);//革命灵魂手铳
		im.sendOk("获得了 #z1222074# x 1");
		im.worldSpouseMessage(0x24,"『革命武器箱』：玩家 "+ im.getChar().getName() +" 获得了革命灵魂手铳。");	
		im.dispose();
	} else {
               im.sendOk("失败：\r\n\r\n#r1). 您的等级不够100级.无法领取.\r\n2). 您当前在线雪花币不足30币。请去市场挂机");
		im.dispose();
	...
	case 2:
           if (im.getLevel() >= 100 && im.getPlayerPoints() > 30) {
		im.gainItem(2432068, -1);
		im.gainItem(1232074, 1);//革命恶魔剑
		im.sendOk("获得了 #z1232074# x 1");
		im.worldSpouseMessage(0x24,"『革命武器箱』：玩家 "+ im.getChar().getName() +" 获得了革命恶魔剑。");	
		im.dispose();
	} else {
               im.sendOk("失败：\r\n\r\n#r1). 您的等级不够100级.无法领取.\r\n2). 您当前在线雪花币不足30币。请去市场挂机");
		im.dispose();
	...
	case 3:
           if (im.getLevel() >= 100 && im.getPlayerPoints() > 30) {
		im.gainItem(2432068, -1);
		im.gainItem(1402210, 1);//革命双手剑
		im.sendOk("获得了 #z1402210# x 1");
		im.worldSpouseMessage(0x24,"『革命武器箱』：玩家 "+ im.getChar().getName() +" 获得了革命双手剑。");	
		im.dispose();
	} else {
               im.sendOk("失败：\r\n\r\n#r1). 您的等级不够100级.无法领取.\r\n2). 您当前在线雪花币不足30币。请去市场挂机");
		im.dispose();
	...
	case 4:
           if (im.getLevel() >= 100 && im.getPlayerPoints() > 30) {
		im.gainItem(2432068, -1);
		im.gainItem(1242080, 1);//革命锁链剑
		im.sendOk("获得了 #z1242080# x 1");
		im.worldSpouseMessage(0x24,"『革命武器箱』：玩家 "+ im.getChar().getName() +" 获得了革命锁链剑。");	
		im.dispose();
	} else {
               im.sendOk("失败：\r\n\r\n#r1). 您的等级不够100级.无法领取.\r\n2). 您当前在线雪花币不足30币。请去市场挂机");
		im.dispose();
	...
	case 5:
           if (im.getLevel() >= 100 && im.getPlayerPoints() > 30) {
		im.gainItem(2432068, -1);
		im.gainItem(1302289, 1);//革命剑
		im.sendOk("获得了 #z1302289# x 1");
		im.worldSpouseMessage(0x24,"『革命武器箱』：玩家 "+ im.getChar().getName() +" 获得了革命剑。");	
		im.dispose();
	} else {
               im.sendOk("失败：\r\n\r\n#r1). 您的等级不够100级.无法领取.\r\n2). 您当前在线雪花币不足30币。请去市场挂机");
		im.dispose();
