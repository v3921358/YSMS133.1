...
var status;
var price1 = 1 * 100000; //鱼饵价格 (冒险币)
var price2 = 100; //高级鱼饵价格 (点卷)
var price_st = -1;
var choose = -1;
var chooses = -1;
var str_name = '';
...
function action(mode, type, selection) {
    ...
    if (status == 0) {
        var str ="#d" + tz7 + "" + tz8 + "" + tz7 + "" + tz8 + "" + tz7 + "" + tz8 + "" + tz7 + "" + tz8 + "" + tz7 + "" + tz8 + "" + tz7 + "" + tz8 + "" + tz7 + "" + tz8 + "" + tz7 + "" + tz8 + "" + tz7 + "" + tz8 + "" + tz7 + "" + tz8 + "" + tz7 + "" + tz8 + "" + tz7 + "" + tz8 + "" + tz7 + "" + tz8 + "" + tz7 + "" + tz8 + "#k\r\n";
			...
			str += "\r\n    " + tz1 + " 很高兴来到我们的钓鱼场，请问你需要什么服务：\r\n";
		//str +="#d" + tz7 + "" + tz8 + "" + tz7 + "" + tz8 + "" + tz7 + "" + tz8 + "" + tz7 + "" + tz8 + "" + tz7 + "" + tz8 + "" + tz7 + "" + tz8 + "" + tz7 + "" + tz8 + "" + tz7 + "" + tz8 + "" + tz7 + "" + tz8 + "" + tz7 + "" + tz8 + "" + tz7 + "" + tz8 + "" + tz7 + "" + tz8 + "" + tz7 + "" + tz8 + "" + tz7 + "" + tz8 + "#k\r\n";

        str += "#r#L6#" + tz7 + "" + tz8 + "" + tz7 + "" + tz8 + "" + tz7 + "" + tz8 + "" + tz7 + "" + tz8 + "钓鱼能获得什么？" + tz7 + "" + tz8 + "" + tz7 + "" + tz8 + "" + tz7 + "" + tz8 + "" + tz7 + "" + tz8 + "#b#l\r\n\r\n";
	//str +="#d" + tz7 + "" + tz8 + "" + tz7 + "" + tz8 + "" + tz7 + "" + tz8 + "" + tz7 + "" + tz8 + "" + tz7 + "" + tz8 + "" + tz7 + "" + tz8 + "" + tz7 + "" + tz8 + "" + tz7 + "" + tz8 + "" + tz7 + "" + tz8 + "" + tz7 + "" + tz8 + "" + tz7 + "" + tz8 + "" + tz7 + "" + tz8 + "" + tz7 + "" + tz8 + "" + tz7 + "" + tz8 + "#k\r\n";

        str += "#L0##b " + tz1 + " 普通钓竿#r(60秒每次)#b#l ";
        str += "#L14#  " + tz1 + " 高级鱼竿#r(30秒每次)#b#l\r\n\r\n";
        str += "#L1# " + tz1 + " 普通鱼饵#r(80-140道具)#b#l";
        str += "#L2# " + tz1 + " 高级鱼饵#r(80-160道具)#b#l\r\n\r\n";
        str += "#L3# " + tz1 + " 使用各种鱼兑换成积分#b";
		str += "#L16# " + tz1 + " 使用积分兑换道具#b\r\n";
	...
	str +="\r\n#d" + tz7 + "" + tz8 + "" + tz7 + "" + tz8 + "" + tz7 + "" + tz8 + "" + tz7 + "" + tz8 + "" + tz7 + "" + tz8 + "" + tz7 + "" + tz8 + "" + tz7 + "" + tz8 + "" + tz7 + "" + tz8 + "" + tz7 + "" + tz8 + "" + tz7 + "" + tz8 + "" + tz7 + "" + tz8 + "" + tz7 + "" + tz8 + "" + tz7 + "" + tz8 + "" + tz7 + "" + tz8 + "#k\r\n";
        ...
        if (choose == 0) {//普通鱼竿 1天
            if (cm.getMeso() >= 100000000 && cm.canHold(5340000)) {
