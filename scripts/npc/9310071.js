...
function action(mode, type, selection) {
	if (mode == -1) {
		...
		if (status == 0) {
			...
			var text="你好，我是充值活动管理员。\r\n\r\n#b本服每充值1元即可获得1点积分，可以在活动开启时兑换好礼\r\n也可以在市场3楼使用积分抽奖，积分抽奖有机会拿暴君哦。\r\n"
			...
			if (selection==1) {
				...
				text+="\r\n#d#e月充值排行奖励如下：#n#k\r\n";
				text+="#r#e第一名#n#k 可获得#b全属性80，HP+10000#k#v1142499#专属勋章（为期一个月），超级、高级、大师魔方x500，闪炫魔方x100\r\n";
				text+="#g======================================================\r\n";
				text+="#r#e第二名#n#k 可获得#b全属性50，HP+8000#k#v1142498#专属勋章（为期一个月），超级、高级、大师魔方x400\r\n";
				text+="#g======================================================\r\n";
				text+="#r#e第三名#n#k 可获得#b全属性30，HP+3000#k#v1142497#专属勋章（为期一个月），超级、高级、大师魔方x300\r\n";
				text+="#g======================================================\r\n";
				text+="#b#r1-3#b名返还该月充值总金额的20%点券，以及上述相应奖励。\r\n#r4-6#b名返还该月充值总金额的10%点券，以及200个魔方。\r\n#r7-10#b名返还该月充值总金额的5%点券，以及100个魔方。";
				cm.sendOk(text);
				cm.dispose();
			}
		}
