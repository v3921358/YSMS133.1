...
var tiaotiaomaps = Array(
        ...
        Array(280020000,"火山的心脏 丰富奖励"),
        Array(109040001,"共4阶段 丰富奖励"),
        Array(910130000,"忍苦树林 丰富奖励"),
        //Array(109030001,"上楼找出口"),
       // Array(109040001,"高地第1阶段"),
        Array(910360000,"地铁B1 丰富奖励"),
        Array(910360100,"地铁B2 丰富奖励"),
        Array(910360200,"地铁B3 丰富奖励")
        ); 
...
function action(mode, type, selection) {
    if (mode == -1) {
        ...
        if (a == -1) {
            ...
            cm.sendSimple("#h0#，这里可以连接到各个地方：" + (isopenvip ? "#r(VIP免费)#b" : "" ) + "\r\n#L0# "+icon+" 城镇地图。\r\n")
        } else if (a == 1) {
            var text = "请选择你要接连的地方：\r\n#b"
            switch (selection) {
                case 0:
