...
function action(mode, type, selection) {
    ...
    //var selStr = "#b"+tz+"亲爱的"+tz+" #r#h ##k"+tz+" 您好 \r\n";
		 var selStr = "#d您当前可用星币： #r" + cm.getRMB() + "#k #d元#k\r\n#e#d请选择：(#r请看好购买哦.点了就买啦!#k):\r\n#n#k";

		selStr += "#b#L108#"+tz+" 购买      【#r双倍经验双倍爆率#b】#l#k\r\n";
		selStr += "#b#L106#"+tz+" 购买      【#r超值礼包#b】#l#k\r\n";
		selStr += "#b#L100#"+tz+" 购买      【#r最新版椅子#b】#l#k\r\n";

		selStr += "#b#L103#"+tz+" 购买      【#r150级武器#b】#l#k\r\n";
		selStr += "#b#L102#"+tz+" 购买      【#r150级防具#b】#l#k\r\n";
		selStr += "#b#L105#"+tz+" 购买      【#r极品卷轴#b】#l#k\r\n";

		selStr += "#b#L109#"+tz+" 购买      【#r高级银河副手#b】#l#k\r\n";
		selStr += "#b#L110#"+tz+" 购买      【#r高级机器人#b】#l#k\r\n";
		selStr += "#b#L111#"+tz+" 购买      【#r高级饰品#b】#l#k\r\n";
		selStr += "#b#L112#"+tz+" 购买      【#r蜡笔礼包#b】#l#k\r\n";
		selStr += "#b#L113#"+tz+" 购买      【#r稀有骑宠#b】#l#k\r\n";
		selStr += "#L0#"+tz+" 回主菜单#l#k\r\n";

		//selStr += "#L17##r"+tz+"装备"+tz+"#l		#L19#"+tz+"礼包"+tz+"#l \t   #L20#"+tz+"消耗"+tz+"#l\r\n\r\n";
				//selStr += "#b#L104#"+tz+"#r礼包#l\r\n";
		//selStr += "#b#L101#"+tz+" #r武器#l\r\n";
//selStr += "#L22##e#b本周特价大优惠#r（第一期）#b每周更新一次#l	  \r\n\t";//#L20#特殊卷轴#l #L22##e#b限时优惠神秘商品（第一期）#l	
	...
	case 106:
            cm.dispose();
            cm.openNpc(1012124, 211); //超值礼包
            break;
	case 108:
            cm.dispose();
            cm.openNpc(1012124, 212); //双倍经验双倍爆率
            break;
	case 109:
            cm.dispose();
            cm.openNpc(1012124, 214); //银河职业副手
            break;
	case 110:
            cm.dispose();
            cm.openNpc(1012124, 215); //机器人专卖
            break;
	case 111:
            cm.dispose();
            cm.openNpc(1012124, 216); //饰品商店
            break;
	case 112:
            cm.dispose();
            cm.openNpc(1012124, 213); //蜡笔礼包
            break;
	case 113:
            cm.dispose();
            cm.openNpc(1012124, 217); //稀有骑宠
            break;
