...
function action(mode, type, selection) {
	if (mode == -1) {
		...
		if (mode == 1)
			...
			status--;
		if (status == 0) {
			cm.sendYesNo("#d女皇希纳斯手下部下众多,如今需要勇敢的冒险家前往消灭他们,众多将领等待消灭，共 #r20#k #d波怪物。#k\r\n#e#d评分 #bB#k#n #r(每人将获得5 个#t5062500#  5 个#t5062009#)\r\n#e#d评分 #bA#k#n #r(每人将获得10 个#t5062500#  10 个#t5062009#)\r\n#e#d评分 #bF#k#n #r(每人将获得 20 个#t5062500# 20 个#t5062009#)\r\n#e#d评分 #bS#k#n#r (每人将获得 30 个#t5062500# 30 个#t5062009#)\r\n#r#e注意事项#k#n：该副本怪物血量较多，建议多人组队消灭。\r\n#e#r副本要求#k#n：#b建议180级以上，自身HP大于10万。#k\r\n#r#e副本提示#n#k：如果中途掉线都是可以重新开始不算次数的\r\n如果你今天领取过奖励后,再进入是不能再领取奖励的");					
		} else if (status == 1) {
		 if (cm.getLevel() <= 179) {
...
cm.channelMessage(0x18, "『小试牛刀』" + " : " + "恭喜" + cm.getChar().getName() + ",和他的队友开始了小试牛刀，祝他取得好的成绩");
