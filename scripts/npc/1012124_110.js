...
function action(mode, type, selection) {
    ...
    if (cm.getMapId() == 180000001) {
		...
		selStr += "#b#L1#  1). 【新手必看快速明白玩法】#l \r\n";
		selStr += "#b#L2#  2). 【我该如何变强变厉害】#l \r\n";
		selStr += "#b#L3#  3). 【我该如何快速提升等级】#l \r\n";
		selStr += "#b#L4#  4). 【赞助充值有什么好处】#l \r\n";
		selStr += "#b#L5#  5). 【加入本服玩家交流群】#l \r\n";
		selStr += "#b#L6#  6). 【不花钱高级装备的来源】#l \r\n";
		selStr += "#b#L7#  7). 【法弗纳150级武器材料出处】#l \r\n";
		selStr += "#b#L8#  8). 【游戏币点卷以及抵用卷来源】#l \r\n";
		selStr += "#b#L8#  9). 【Gm指导您如何经济来源】#l \r\n";		
		selStr += "#b#L10# 10). 【领取210级每日奖励】#l \r\n";
