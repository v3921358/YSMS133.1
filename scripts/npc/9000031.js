...
function action(mode, type, selection) {
	if (mode == -1) {
		...
		if (status == 0) {
			...
			var selStr = "\t#r#e恭禧發財#n#k：#bhi,我是男神派来发红包的哟。请打怪收集#k\r\n\r\n- #d当前背包已拥有#k\r\n\r\n#i4034251# x #r" + cm.getItemQuantity("4034251") + "#k    #i4034252# x #r" + cm.getItemQuantity("4034252") + "#k    #i4034253# x #r" + cm.getItemQuantity("4034253") + "#k    #i4034254# x #r" + cm.getItemQuantity("4034254") + "#k\r\n\r\n";
			selStr +="#L1##b"+aaa+" #r#i4034251# + #i4034252# #b兑换 #r魔方卷轴#l#k\r\n";
			selStr +="#L2##b"+aaa+" #r#i4034253# + #i4034254# #b兑换 #r大量金币#l#k\r\n";
			selStr +="#L3##b"+aaa+" #r#i4034251# + #i4034252# + #i4034253# + #i4034254# #b兑换 #r点卷或抵用卷#l#k\r\n";
			selStr +=" \r\n\r\n";
			...
			//cm.worldSpouseMessage(0x20, "『恭.禧.發.財』 : 恭喜 " + cm.getChar().getName() + " 在贺客卡珊德拉处获得了 " + ii.getName(mf[chance]) + " 20个.");
			cm.dispose();
				} else {
			...
			cm.worldSpouseMessage(0x20, "『恭.禧.發.財』 : 恭喜 " + cm.getChar().getName() + " 在贺客卡珊德拉处获得了 " + chance1 + " 金币.");
			cm.dispose();
				} else {
			...
			cm.worldSpouseMessage(0x20, "『恭.禧.發.財』 : 恭喜 " + cm.getChar().getName() + " 在贺客卡珊德拉处获得了 " + chance2 + " 点卷或抵用卷.");
			cm.dispose();
				} else {
