...
function action(mode, type, selection) {
    ...
    if (cm.getMapId() == 180000001) {
		...
		//var selStr = "这里的功能能使你变得更加强大。\r\n\r\n";
            var selStr = "#e#g  "+epp+" 我要变强提升战力 "+epp+"#n#k\r\n";
          	selStr += "" + tz12 + "" + tz13 + "" + tz14 + "" + tz12 + "" + tz13 + "" + tz14 + "" + tz12 + "" + tz13 + "" + tz14 + "" + tz12 + "" + tz13 + "" + tz14 + "" + tz12 + "" + tz13 + "" + tz14 + "" + tz12 + "" + tz13 + "" + tz14 + "" + tz12 + "\r\n"


		selStr += "#r#L1#"+tz20+" 蜡笔潜能#l #L2#"+tz20+" 武器破功#l #L3#"+tz20+" 装备合成#l\r\n";
		selStr += "#r#L4#"+tz20+" 翅膀进阶#l #L5#"+tz20+" 粉笔强化#l #L6#"+tz20+" 点装强化#l\r\n";
		selStr += "#r#L7#"+tz20+" 增加血量#l #L8#"+tz20+" 装备制作#l #L9#"+tz20+" 装备还原#l\r\n";
		selStr += "#r#L10#"+tz20+" 点卷道具#l #L11#"+tz20+" 伤害皮肤#l #L12#"+tz20+" 职业副手#l\r\n";
		selStr += "#r#L13#"+tz20+" 购买卷轴#l #L14#"+tz20+" 理财钱庄#l #L15#"+tz20+" 点卷中介#l\r\n";
          	selStr += "" + tz12 + "" + tz13 + "" + tz14 + "" + tz12 + "" + tz13 + "" + tz14 + "" + tz12 + "" + tz13 + "" + tz14 + "" + tz12 + "" + tz13 + "" + tz14 + "" + tz12 + "" + tz13 + "" + tz14 + "" + tz12 + "" + tz13 + "" + tz14 + "" + tz12 + "\r\n"
		selStr += "#e#g  "+epp+" 点点祝您游戏愉快 "+ epp +"#n#k\r\n";

		selStr += "#e#g  #L0#"+epp+" 点击返回上一页 "+epp+"#l\r\n";
