...
function action(mode, type, selection) {
	if (mode == -1) {
		...
		if (status == 0) {
			...
			//selStr +="#L1##r"+tz1+"  购买真系法弗纳系列武器#l#k\r\n"; 
			//selStr +="#L10##b"+tz1+"  购买150级 鲁塔比斯/暴君防具#l#k\r\n"; 
			//selStr +="#L12##b"+tz1+"  购买150级 天然法弗纳武器#l#k\r\n"; 
			selStr +="#L2#"+tz1+" #r 10#k #b现金点购买 #r#z4001006#礼包#k#l#k\r\n";
			...
			selStr +="#L6#"+tz1+" #r100#k #b现金点购买 #r#z5062010#礼包(大)#k#l#k\r\n";
			selStr +="#L7#"+tz1+" #r100#k #b现金点购买 #r无损#z2049323#礼包#k#l#k\r\n";
			...
			if (selection == 1) {
				...
				typed=10;
				cm.sendYesNo("购买150级鲁塔比斯/暴君防具。您是否要查看购买?");
			} else if (selection == 12) {
				typed=12;
				cm.sendYesNo("购买150级法弗纳武器。您是否要查看购买?");
			...
			cm.worldSpouseMessage(0x20, "『现金商城』 : 恭喜 " + cm.getChar().getName() + " 在现金商城购买火焰羽毛礼包.");
			cm.dispose();
				} else {
			cm.sendOk("购买失败：\r\n\r\n#r1). 当前余额不足.\r\n2). 背包栏位已满,请清理.");
			cm.dispose();
			...
			cm.worldSpouseMessage(0x20, "『现金商城』 : 恭喜 " + cm.getChar().getName() + " 在现金商城购买粉笔强化礼包.");
			cm.dispose();
				} else {
			cm.sendOk("购买失败：\r\n\r\n#r1). 当前余额不足.\r\n2). 背包栏位已满,请清理.");
			cm.dispose();
			...
			cm.worldSpouseMessage(0x20, "『现金商城』 : 恭喜 " + cm.getChar().getName() + " 在现金商城购买终极神奇魔方礼包(小).");
			cm.dispose();
				} else {
			cm.sendOk("购买失败：\r\n\r\n#r1). 当前余额不足.\r\n2). 背包栏位已满,请清理.");
			cm.dispose();
			...
			cm.worldSpouseMessage(0x20, "『现金商城』 : 恭喜 " + cm.getChar().getName() + " 在现金商城购买终极神奇魔方礼包(中).");
			cm.dispose();
				} else {
			cm.sendOk("购买失败：\r\n\r\n#r1). 当前余额不足.\r\n2). 背包栏位已满,请清理.");
			cm.dispose();
			...
			cm.worldSpouseMessage(0x20, "『现金商城』 : 恭喜 " + cm.getChar().getName() + " 在现金商城购买终极神奇魔方礼包(大).");
			cm.dispose();
				} else {
			cm.sendOk("购买失败：\r\n\r\n#r1). 当前余额不足.\r\n2). 背包栏位已满,请清理.");
			cm.dispose();
			...
			cm.worldSpouseMessage(0x20, "『现金商城』 : 恭喜 " + cm.getChar().getName() + " 在现金商城购买无损高级装备强化卷.");
			cm.dispose();
				} else {
			cm.sendOk("购买失败：\r\n\r\n#r1). 当前余额不足.\r\n2). 背包栏位已满,请清理.");
			cm.dispose();
			...
			cm.worldSpouseMessage(0x20, "『现金商城』 : 恭喜 " + cm.getChar().getName() + " 在现金商城购买 正向混沌卷轴.");
			cm.dispose();
				} else {
			cm.sendOk("购买失败：\r\n\r\n#r1). 当前余额不足.\r\n2). 背包栏位已满,请清理.");
			cm.dispose();
			...
			cm.worldSpouseMessage(0x20, "『现金商城』 : 恭喜 " + cm.getChar().getName() + " 在现金商城购买 惊人正义混沌卷轴 20%.");
			cm.dispose();
				} else {
			cm.sendOk("购买失败：\r\n\r\n#r1). 当前余额不足.\r\n2). 背包栏位已满,请清理.");
			cm.dispose();
			...
			cm.worldSpouseMessage(0x20, "『现金商城』 : 恭喜 " + cm.getChar().getName() + " 在现金商城购买星岩魔方礼包.");
			cm.dispose();
				} else {
			cm.sendOk("购买失败：\r\n\r\n#r1). 当前余额不足.\r\n2). 背包栏位已满,请清理.");
			cm.dispose();
