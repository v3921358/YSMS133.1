...
var item = Array(
        ...
        Array(1102383, 8800),
        Array(1142524, 12000),
		Array(1072732, 20000), // 赫里希安精锐战士靴 // (无描述)
		Array(1072733, 20000), // 赫里希安精锐法师靴 // (无描述)
		Array(1072734, 20000), // 赫里希安精锐弓箭手靴 // (无描述)
		Array(1072735, 20000), // 赫里希安精锐飞侠靴 // (无描述)
		Array(1072736, 20000), // 赫里希安精锐海盗靴 // (无描述)
        Array(1102476, 20000),
        Array(1102477, 20000),
        Array(1102478, 20000),
        Array(1102479, 20000),
    ...
    if (mode == -1) {
        ...
        if (a == -1) {
            ...
            if (cm.getParty() == null) { // 没有组队
                ...
                cm.sendOk("请叫队长和我谈话。");
                cm.dispose();
            } else if (cm.getBossLog('天空庭院') >= 2) {
                cm.sendOk("你不能进去，天空庭院一天只能进入2次。")
                cm.dispose();
            } else {
