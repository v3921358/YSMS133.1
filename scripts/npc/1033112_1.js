...
function action(mode, type, selection) {
    ...
    if (cm.getMapId() == 180000001) {
		...
		selStr += "#L11#" + ttt + " #b[单人]不忘国耻报仇雪恨  ==#k#n（升级经验、暗影币）#l\r\n";
		...
		selStr += "#L15#" + ttt + " #b[单人]新武林  == #k#n(经验金币)#l\r\n";
       		selStr += "#L10#" + ttt + " #b[单人]阿里安特竞技场  == #k#n(征服者币) #k#l\r\n\r\n";

		selStr += "#L27#" + ttt + " #b[组队]枫之高校 == #k#n高经验#k#l#n\r\n";
        ...
        switch (selection) {
            ...
            case 11://小鬼子
                ...
                //cm.warp(746000016, 0);
                //break;
                if (cm.getEventCount("消灭小日本") < 3) {
		cm.dispose();
		cm.openNpc(9000159);
		}else{
		cm.sendOk("今天该帐号已经完成[单人]报仇3次。");
		cm.dispose();
		}
                break;
            case 12:
