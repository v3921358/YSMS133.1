...
function action(mode, type, selection) {
    if (mode == -1) {
		...
		if (cm.getBossLog("钻机") < maxPierre1){
                    ...
                    if (next) {
                        var em = cm.getEventManager("ZChaosPQ11");
                        if (em == null) {
                            cm.sendOk("此任务正在建设当中。");
                        } else {
                            ...
                            if (prop.equals("0") || prop == null) {
                                ...
                                cm.sendOk("钻机副本 - 普通模式，里面已经有人了，请稍等！");
                            }
                        }
                        cm.dispose();
                    } else {
