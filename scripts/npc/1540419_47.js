...
function action(mode, type, selection) {
    ...
    if (status == 0) {
    var selStr = "#亲爱的#r#h ##k您好，这里是点装商店，请您选择您需要的功能:\r\n";
		selStr += "#d您当前点券： #r"+cm.getNX(1)+"#k #d点#k\t#d当前抵用券： #r" + cm.getNX(2) + "#k #d点#k\r\n#e#d请选择：(#r请看好购买哦.点了就买啦!#k):\r\n#n#k";
		selStr += "#b#L0#稀有戒指#l	    #L2#稀有帽子#l       #L4#稀有披风\r\n";
		selStr += "#L6##b稀有裤裙#l	    #L7#稀有上衣#l       #L5#稀有其它#l\r\n";
		selStr += "#L8##b稀有手套#l	    #L9#稀有套装#l       #L1#稀有鞋子#l\r\n";
		selStr += "#L10##b稀有武器#l	\t#L11#稀有宠物#l \t   #L12#稀有玩具#l\r\n";
