        ...
        switch (selection) {
            ...
            if (cm.haveItem(1142318, 1) && cm.getPlayer().getLevel() > 200 && cm.getBossLog("少校") < 1) {
               ...
               //cm.gainItem(2340000,20);
                ...
                cm.sendOk("#r#e尊敬的少校，\r\n#k祝你游戏愉快!");
				cm.worldSpouseMessage(0x20, "『军事新闻』 : " + cm.getChar().getName() + "[少校] 领取了奖励，大家快去打劫他！☆☆☆☆☆☆");
				cm.worldSpouseMessage(0x20, "『军事新闻』 : " + cm.getChar().getName() + "[少校] 领取了奖励，大家快去打劫他！☆☆☆☆☆☆");
				cm.worldSpouseMessage(0x20, "『军事新闻』 : " + cm.getChar().getName() + "[少校] 领取了奖励，大家快去打劫他！☆☆☆☆☆☆");
				cm.dispose();
            } else {
            ...
            break;
			        case 2:
            if (cm.haveItem(1142319, 1) && cm.getPlayer().getLevel() > 220 && cm.getBossLog("中校") < 1) {
				cm.setBossLog("中校");
                ...
                cm.sendOk("#r#e尊敬的中校，\r\n#k祝你游戏愉快!");
				cm.worldSpouseMessage(0x20, "『军事新闻』 : " + cm.getChar().getName() + "[中校] 领取了奖励，大家快去打劫他！☆☆☆☆☆☆");
				cm.worldSpouseMessage(0x20, "『军事新闻』 : " + cm.getChar().getName() + "[中校] 领取了奖励，大家快去打劫他！☆☆☆☆☆☆");
				cm.worldSpouseMessage(0x20, "『军事新闻』 : " + cm.getChar().getName() + "[中校] 领取了奖励，大家快去打劫他！☆☆☆☆☆☆");
				cm.worldSpouseMessage(0x20, "『军事新闻』 : " + cm.getChar().getName() + "[中校] 领取了奖励，大家快去打劫他！☆☆☆☆☆☆");
				cm.dispose();
            ...
            break;
			        case 3:
            if (cm.haveItem(1142320, 1) && cm.getPlayer().getLevel() > 230 && cm.getBossLog("上校") < 1) {
				cm.setBossLog("上校");
                ...
                cm.sendOk("#r#e尊敬的上校，\r\n#k祝你游戏愉快!");
				cm.worldSpouseMessage(0x20, "『军事新闻』 : " + cm.getChar().getName() + "[上校] 领取了奖励，大家快去打劫他！☆☆☆☆☆☆");
				cm.worldSpouseMessage(0x20, "『军事新闻』 : " + cm.getChar().getName() + "[上校] 领取了奖励，大家快去打劫他！☆☆☆☆☆☆");
				cm.worldSpouseMessage(0x20, "『军事新闻』 : " + cm.getChar().getName() + "[上校] 领取了奖励，大家快去打劫他！☆☆☆☆☆☆");
				cm.worldSpouseMessage(0x18, "『军事新闻』 : " + cm.getChar().getName() + "[上校] 领取了奖励，大家快去打劫他！☆☆☆☆☆☆");
				cm.worldSpouseMessage(0x18, "『军事新闻』 : " + cm.getChar().getName() + "[上校] 领取了奖励，大家快去打劫他！☆☆☆☆☆☆");
				cm.worldSpouseMessage(0x18, "『军事新闻』 : " + cm.getChar().getName() + "[上校] 领取了奖励，大家快去打劫他！☆☆☆☆☆☆");
				cm.dispose();                                                                    
            } else {                                                                             
            ...
            break;
			        case 4:
           if (cm.haveItem(1142321, 1) && cm.getPlayer().getLevel() >= 240 && cm.getBossLog("团长") < 1) {
				cm.setBossLog("团长");
                ...
                cm.sendOk("#r#e尊敬的团长，\r\n#k祝你游戏愉快!");
				cm.worldSpouseMessage(0x20, "『军事新闻』 : " + cm.getChar().getName() + "[团长] 领取了奖励，大家快去打劫他！☆☆☆☆☆☆");
				cm.worldSpouseMessage(0x20, "『军事新闻』 : " + cm.getChar().getName() + "[团长] 领取了奖励，大家快去打劫他！☆☆☆☆☆☆");
				cm.worldSpouseMessage(0x20, "『军事新闻』 : " + cm.getChar().getName() + "[团长] 领取了奖励，大家快去打劫他！☆☆☆☆☆☆");
				cm.worldSpouseMessage(0x18, "『军事新闻』 : " + cm.getChar().getName() + "[团长] 领取了奖励，大家快去打劫他！☆☆☆☆☆☆");
				cm.worldSpouseMessage(0x18, "『军事新闻』 : " + cm.getChar().getName() + "[团长] 领取了奖励，大家快去打劫他！☆☆☆☆☆☆");
				cm.worldSpouseMessage(0x18, "『军事新闻』 : " + cm.getChar().getName() + "[团长] 领取了奖励，大家快去打劫他！☆☆☆☆☆☆");
				cm.worldSpouseMessage(0x15, "『军事新闻』 : " + cm.getChar().getName() + "[团长] 领取了奖励，大家快去打劫他！☆☆☆☆☆☆");
				cm.worldSpouseMessage(0x15, "『军事新闻』 : " + cm.getChar().getName() + "[团长] 领取了奖励，大家快去打劫他！☆☆☆☆☆☆");
				cm.dispose();
            } else {
                cm.sendOk("信不信我分分钟枪毙你？");
