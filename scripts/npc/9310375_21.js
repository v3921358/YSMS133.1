...
var ItemArray = Array(
Array(3010415, 1, -1, 3000),
Array(3010458, 1, -1, 3000),//翻滚兔子椅子
Array(3010457, 1, -1, 3000),//拉尼娅野餐椅
Array(3010503, 1, -1, 3000),
        Array(2049100, 1, 1, 100),//混沌卷轴60%
        Array(2340000, 1, -1, 50),//祝福卷轴
        Array(2046913, 1, 1, 10000),// 宿命正义单手武器攻击力卷轴 100%
	Array(2046914, 1, 1, 10000), // 宿命正义单手武器魔力卷轴 100% // 为单手武器增加魔法攻击力属性。
	Array(2046173, 1, 1, 10000), // 宿命正义双手武器攻击力卷轴 100% // 为双手武器增加攻击力属性。
	Array(4001714, 1, -1, 50),
Array(1190401, 1, 10, 5000),  // C等级BOSS竞技场徽章 // (无描述)
Array(1190402, 1, -1, 6000),  // B//等级BOSS竞技场徽章 // (无描述)
Array(1190403, 1, -1, 7000),  // B等级BOSS竞技场徽章 // (无描述)
Array(1190404, 1, -1, 8000),  // B+等级BOSS竞技场徽章 // (无描述)
Array(1190405, 1, -1, 10000),  // A等级BOSS竞技场徽章 // (无描述)
Array(1190406, 1, -1, 15000)  // A+等级BOSS竞技场徽章 // (无描述)
        );//道具id，个数，剩余天数，所需积分
