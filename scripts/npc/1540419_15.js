...
function action(mode, type, selection) {
    ...
    if (status == 0) {
        ...
        case 0:
            cm.dispose();
            cm.openNpc(9310382, 151); //双倍道具
            break;
        case 4:
            cm.dispose();
            cm.openNpc(9310382, 152); //绝版点装
            break;
        case 5:
            cm.dispose();
            cm.openNpc(9310382, 156); //各种椅子
            break;
        case 6:
            cm.dispose();
        ...
        case 7:
            cm.dispose();
            cm.openNpc(9310382, 154); //洗点卷轴
            break;
        case 8:
            cm.dispose();
            cm.openNpc(9310382, 155); //玩具商店
            break;
        case 9:
            cm.dispose();
            cm.openNpc(9310382,153); //宠物
            break;
	case 10:
            cm.dispose();
