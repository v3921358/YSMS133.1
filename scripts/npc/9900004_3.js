...
function action(mode, type, selection) {
    ...
    if (status == 0) {
      ...
      switch (selection) {
        case 0:
           if (cm.getPlayer().getCSPoints(2)>=20000 && cm.getBossLog("普通扎昆") > 1) {
		    cm.gainNX(2,-20000);
		    ...
		    cm.dispose();
            	    ...
            	    break;
        case 1:
           if (cm.getPlayer().getCSPoints(2)>=20000 && cm.getBossLog("普通黑龙") > 1) {
		    cm.gainNX(2,-20000);
		    ...
		    cm.dispose();
            	    ...
            	    break;
        case 2:
           if (cm.getPlayer().getCSPoints(2)>=30000 && cm.getBossLog("进阶扎昆") > 1) {
		    cm.gainNX(2,-30000);
		    ...
		    cm.dispose();
            	    ...
            	    break;
        case 3:
           if (cm.getPlayer().getCSPoints(2)>=30000 && cm.getBossLog("进阶黑龙") > 1) {
		    cm.gainNX(2,-30000);
