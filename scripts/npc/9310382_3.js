...
function action(mode, type, selection) {
	if (mode == -1) {
		...
		if (status == 0) {
			...
			//text+="#b#L1#领取星之力勋章[开服7天有效]#l\r\n";
			//text+="#r#L6#暑假怎能少了猜谜，用智商碾压土豪！#l\r\n#b";
			//text+="#L2#领取开服冲级七天礼[2015年7月18日-2015年7月24日]#l\r\n";
			//text+="#L3#领取开服首冲奖励[2015年7月7日-2015年7月13日]#l\r\n";
			text+="#L4#天降点卷活动[2015年7月21日-2015年7月30日]#l\r\n"
			//text+="#r#L5#28日停服维护补偿[2015年3月1日晚上8点40分]#l\r\n"
			//text+="#L3#了解什么是节日礼物#l\r\n";//限量礼包将于今晚8:30开始发放
			//text+="#r#L7#领取福利限量礼包[2015年7月17日晚上8点30分开始发放]#l\r\n"
			cm.sendSimple(text);
		} else if (status == 1){
			if (selection == 1) {
