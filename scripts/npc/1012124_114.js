...
function action(mode, type, selection) {
    ...
    if (status == 0) {
       // var str ="#d" + tz7 + "" + tz8 + "" + tz7 + "" + tz8 + "" + tz7 + "" + tz8 + "" + tz7 + "" + tz8 + "" + tz7 + "" + tz8 + "" + tz7 + "" + tz8 + "" + tz7 + "" + tz8 + "" + tz7 + "" + tz8 + "" + tz7 + "" + tz8 + "" + tz7 + "" + tz8 + "" + tz7 + "" + tz8 + "" + tz7 + "" + tz8 + "" + tz7 + "" + tz8 + "" + tz7 + "" + tz8 + "#k\r\n";
		...
		var 	str = "\r\n\t很高兴来到我们的钓鱼场，请问你需要什么服务：\r\n\r\n";
		//str +="#d" + tz7 + "" + tz8 + "" + tz7 + "" + tz8 + "" + tz7 + "" + tz8 + "" + tz7 + "" + tz8 + "" + tz7 + "" + tz8 + "" + tz7 + "" + tz8 + "" + tz7 + "" + tz8 + "" + tz7 + "" + tz8 + "" + tz7 + "" + tz8 + "" + tz7 + "" + tz8 + "" + tz7 + "" + tz8 + "" + tz7 + "" + tz8 + "" + tz7 + "" + tz8 + "" + tz7 + "" + tz8 + "#k\r\n";

        str += "#r#L6# " + tz8 + " 钓鱼能获得什么？   #l";
        str += "#L21# " + tz8 + " 钓鱼排名与奖励#b#l\r\n\r\n";
        str += "#L0##b " + tz8 + " 普通钓竿#r(60秒每次)#b#l ";
        str += "#L14# " + tz8 + " 高级鱼竿#r(30秒每次)#b#l\r\n\r\n";
        str += "#L1# " + tz8 + " 普通鱼饵#r(8W金币/条)#b#l";
        str += "#L2# " + tz8 + " 高级鱼饵#r(80抵用卷/条)#b#l\r\n\r\n";
        str += "#L3# " + tz8 + " 使用各种鱼兑换成积分#b";
	str += "#L16#" + tz8 + " 使用积分兑换道具\r\n\r\n";
	str += "#L22# " + tz8 + " #r租借钓鱼专用椅子\r\n\t\r\n";
        //str += "#L7#" + tz8 + "每周钓鱼排行榜大赛奖励#b";
        //str += "\t\r\n";
	...
	//str +="\r\n#d" + tz7 + "" + tz8 + "" + tz7 + "" + tz8 + "" + tz7 + "" + tz8 + "" + tz7 + "" + tz8 + "" + tz7 + "" + tz8 + "" + tz7 + "" + tz8 + "" + tz7 + "" + tz8 + "" + tz7 + "" + tz8 + "" + tz7 + "" + tz8 + "" + tz7 + "" + tz8 + "" + tz7 + "" + tz8 + "" + tz7 + "" + tz8 + "" + tz7 + "" + tz8 + "" + tz7 + "" + tz8 + "#k\r\n";
        ...
        if (selection == 21) {
            cm.dispose();
            cm.openNpc(1012124, 117);
        }
        if (selection == 22) {
            cm.dispose();
            cm.openNpc(1012124, 118);
        }
    } else if (status == 2) {
        if (choose == 0) {//普通鱼竿 1天
            if (cm.getMeso() >= 50000000 && cm.canHold(5340000)) {
        ...
        if (choose == 9) {//普通鱼竿 永久
            if (cm.getRMB() >= 80 && cm.canHold(5340000)) {
                cm.gainItem(5340000, 1);
		cm.gainRMB(-80);
                cm.sendOk("成功购买.");
            } else {
                cm.sendOk("您余额不足.请充值后再来购买");
            }
            cm.dispose();
        }
		...
		if (cm.getRMB() > 5 && cm.canHold(5340001)) {
		...
		//cm.gainItem(5340001, 1, 10);
                ...
                cm.sendOk("你的余额不足5元，请充值后再来购买.");
            }
            cm.dispose();
        }
        if (choose == 15) {//高级鱼竿 永久
            if (cm.getRMB() > 280 && cm.canHold(5340001)) {
