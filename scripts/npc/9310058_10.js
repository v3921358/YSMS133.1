...
function action(mode, type, selection) {
    if (mode == -1) {
        ...
        if (status >= 0 && mode == 0) {
            cm.sendOk("8月13日20:00-8月20日23:00分开放全部怪物掉落#r#t2431854##k#n\r\n温馨提示:前三名奖励是本职业道具哦，无法给别的职业使用\r\n活动奖励将会在8月21日发放。");
            cm.dispose();
        }
        if (mode == 1)
            status++;
            ...
            status--;
        if (status == 0) { 
                cm.sendSimple("#e#d收集情书活动第 #r20150812#d 期#n 七天为一个活动期（1期）\r\n#b举行活动期间只要收集 #r#t2431854# #b即可上交按照排名制度奖励\r\n#r本期收集活动开放时间：8.13日20:00分至8.20日23:00分结束#k\r\n\r\n#b\t第一名奖励 #r本职业暴君防具 x 1。#b\r\n\t第二名奖励 #r本职业140武器 x 1。#b\r\n\t第三名奖励 #r本职业140防具 x 1。#b\r\n\t四至十奖励 #r超级神奇魔方 x 50。#b\r\n\r\n#d所有参与本活动者均可获得#r#e提交1封情书 x 5点卷#n#b奖励。#k#b \r\n当前背包里有： #r" + cm.getItemQuantity("4001248") + " #b个。目前您已经上交了： #r"+getQty()+" #b个。\r\n#L1# 我想查看排名。")//\r\n#L0# 我想提交物品。
        } else if (status == 1) {
            if (selection == 0) {
		...
		cm.worldSpouseMessage(0x23, "『收集情书活动』 : " + cm.getChar().getName() + " 上交 "+quantity+" 封情书,获得了 "+quantity * 5+" 点卷,目前总共上交了 "+getQty()+" 张。");
		}else{
