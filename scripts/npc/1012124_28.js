...
var itemlist = new Array(
        ...
        Array("战士", 1122122, 1000000, "攻击力50 防御20 魔防 20"),
        Array("法师", 1122123, 1000000, "魔法力50 防御20 魔防 20"),
        Array("弓手", 1122124, 1000000, "攻击力50 防御20 魔防 20"),
        Array("飞侠", 1122125, 1000000, "攻击力50 防御20 魔防 20"),
        Array("海盗", 1122126, 1000000, "攻击力50 防御20 魔防 20"),
        //Array("美观", 1142210, 50000, "全属性+7 防御魔防+8"),
        //Array("美观", 1142178, 30000, "全属性+5 移动+7 跳跃+3"),
        Array("全职", 1132245, 300000, "全属性+30 攻击魔攻+20"),
        Array("全职", 1132246, 500000, "全属性+60 攻击魔攻+35 防御魔防+100"),
        Array("全职", 1122266, 300000, "全属性+20 攻击魔攻+3"),
        Array("全职", 1122267, 500000, "全属性+28 攻击魔攻+5"),
        Array("全职", 1032222, 300000, "全属性+12 攻击魔攻+5"),
        Array("全职", 1032223, 500000, "全属性+15 攻击魔攻+9"),
        Array("全职", 1113074, 300000, "全属性+8 攻击魔攻+5"),
        Array("全职", 1113075, 500000, "全属性+10 攻击魔攻+8")
        );
...
function action(mode, type, selection) {
    if (mode == -1) {
        ...
        if (status == 0) {
			...
			seld = selection;
			cm.sendYesNo(head + "确定购买 #r#z" + itemlist[seld][1] + "##k 将会使用掉您 #r" + itemlist[seld][2] + "点卷. 您将获得#r" + itemlist[seld][3] + "#k" + itemlist[seld][0] + "#z" + itemlist[seld][1] + "#。");
        } else if (status == 2) {
			cm.getNX(1);
			//var nx2 = cm.getNX(2);
