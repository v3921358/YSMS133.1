...
function action(mode, type, selection) {
    ...
    if (status == 0) {
        CheckData();//检查数据完整
        var text = "#e#d├───────── 寄售系统 ────────┤#n#k\r\n你目前拥有 【#r" + cm.getPlayer().getCSPoints(1) + "#k】 点卷\r\r你目前拥有 【#r " + cm.getRMB() + "#k】余额\r\n";
        ...
        switch (selection) {
            ...
            case 1://道具
                s = 1;
                cm.sendGetNumber("请输入你要贩卖的道具ID。", 0, 10, 9999999);
                break;
        }
    } else if (status == 3) {
        if (s == 1) {//贩卖装备
            ...
            if (parseInt(itemid / 1000000) == 1) {
                ...
                status = 9;
                s = 1;
                cm.sendSimple("请选择交易的类型：\r\n#L0# " + xxx + " #e#r 金币-收取卖家%5税#n#k#l    #L1# " + xxx + " #e#r 点券-收取卖家%5税#n#k#l    #L2# " + xxx + " #e#d 余额-收取卖家%2税#n#k#l");
            }
        }
