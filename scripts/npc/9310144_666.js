	...
	if (mode == -1) {
		...
		if (status == 0) {
			...
			if (selection == 1) {
				...
				text += "\t购买小福袋套餐可以立刻获得#r永久坐骑[暗光龙]#k，#r20#k张#b无损高级装备强化卷#k，#r10#k张#b#z2049135##k，并发放#r30#k个#b福袋#k，每个#b福袋#k打开可获得#r7000#k#b点卷#k，每天只能使用一个。售价为#b288雪花币#k。\r\n";
				text += "#e#d什么是巨大福袋套餐？#n#k\r\n";
				text += "\t购买巨大福袋套餐可以立刻获得#r永久坐骑[幻龙]#k，不管是否拥有滑翔技能，都可以进行滑翔，#r30#k张#b无损高级装备强化卷#k，#r10#k张#b#z2049137##k，1个#b惊喜箱子#k，打开#b惊喜箱子#k可能随机获得5张星火或者5张惊人武器卷或者暴君装备一件，每个#b巨大福袋#k打开可获得#r10000#k#b点卷#k，每天只能使用一个。售价为#b588雪花币#k。\r\n";
				cm.sendOk(text);
				cm.dispose();
			} else if (selection == 2) {
				cm.sendYesNo("是否要花费#r288#k雪花币购买小福袋套餐？");
				typed=1;
			} else if (selection == 3) {
				cm.sendYesNo("是否要花费#r588#k雪花币购买巨大福袋套餐？");
				typed=2;
			}
		} else if (status == 2) {
			if (typed==1) {				
