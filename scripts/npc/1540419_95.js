...
function action(mode, type, selection) {
    ...
    if (cm.getMapId() == 180000001) {
		...
		var selStr = "\t\t\t\t#e#d  " + tz1+ "福利系统" + tz1+ "#n#l#k\r\n\r\n";
		//var selStr = "#e#d  " + tz7 + "" + tz8 + "" + tz7 + "" + tz8 + "" + tz7 + "" + tz8 + "" + tz7 + "" + tz8 + "" + tz7 + "" + tz8 + " 福利系统" + tz7 + "" + tz8 + "" + tz7 + "" + tz8 + " " + tz7 + "" + tz8 + "" + tz7 + "" + tz8 + "" + tz7 + "" + tz8 + "#n#l#k\r\n";
		...
		selStr += "#b#L1#"+tz1+" 在线奖励#l       #L10#"+tz1+" 等级奖励#l\r\n\r\n";
		selStr += "#b#L7#"+tz1+" 每日礼物#l       #L2#"+tz1+" 七天登陆#l\r\n\r\n";
		selStr += "#b#L21#"+tz1+" 在线抵用#l       #L20#"+tz1+" 在线点卷#l\r\n\r\n";
