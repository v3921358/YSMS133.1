...
function action(mode, type, selection) {
    ...
    if (cm.getMapId() == 180000001) {
		...
		var selStr = "#b"+epp+"这里的功能都是商店功能"+epp+"#k\r\n\r\n";
		selStr += "" + tz12 + "" + tz13 + "" + tz14 + "" + tz12 + "" + tz13 + "" + tz14 + "" + tz12 + "" + tz13 + "" + tz14 + "" + tz12 + "" + tz13 + "" + tz14 + "" + tz12 + "" + tz13 + "" + tz14 + "" + tz12 + "" + tz13 + "" + tz14 + "" + tz12 + "\r\n"
		selStr += "#r#L0#"+tz10+" 杂货商店#l #L1# 双刀商店]#l #L2# 飞镖商店]#l\r\n";
		selStr += "#r#L3#"+tz10+" 特殊商店#l #L4# 外星商店]#l #L5# 狮王商店]#l\r\n";
		selStr += "#r#L6#"+tz10+" 金币商店#l #L7# 抵用商店]#l #L8# 技能书店]#l\r\n";
		selStr += "#r#L9#"+tz10+" 消耗商店#l #L10# 怪物币店]#l #L11# 其它商店]#l\r\n\r\n";
