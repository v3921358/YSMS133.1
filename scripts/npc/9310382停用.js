...
function action(mode, type, selection) {
    ...
    if (cm.getMapId() == 180000001) {
        ...
        var selStr = "欢迎来到 纯爱 冒险岛\r\n\r\n您今天已经进行了游戏:#r"+cm.getGamePoints()+"#k分钟[要合理安排游戏时间噢]\r\n\r\n下面是游戏相关信息:\r\n\糖果：#r"+cm.getPlayerPoints()+"#k	    现金:#r"+cm.getHyPay(1)+"#k\r\n点券:#r" + cm.getPlayer().getCSPoints(1) + "#k#k	抵用券:#r" + cm.getPlayer().getCSPoints(2) + "#k#k\r\n=============================================\r\n\r\n";
        selStr += "#L37##b新人必点.送神器，超强装备.助您快速成长#l#k\r\n\r\n";
       //selStr += "#L7##n回到市场#l";
	...
	if(cm.getPlayer().getLevel() <= 10){
		cm.gainExp( + 50000);
		cm.worldMessage("恭喜新玩家"+ cm.getChar().getName() +"在10周年熊熊妹妹处领取5W经验");
	...
	cm.dispose();
		...
		case 36:
			...
			break;	
		case 37:
         if (cm.getPlayer().getLevel() > 9 && cm.getBossLog("送装备", 1) == 0 && cm.getPlayer().getLevel() < 31) { //cm.getPlayer().getLevel() > 9 && cm.getPlayer().getLevel() < 15) &&
			...
			toDrop.setOwner("纯爱神器");
			cm.addFromDrop(cm.getC(), toDrop, false)	
			cm.setBossLog("送装备", 1);
			cm.sendOk("超强装备已经给您发放.感谢您的支持.");
            } else {
				cm.sendOk("#r管理提示：【领取条件为10--30】级\r\n\r\n#b您已经领取过了，或者等级不足10级,或者等级超过了30级\r\n");
            }
            cm.dispose();
			break;				
		}
