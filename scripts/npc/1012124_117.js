...
function Ranking() {
    ...
    while (RankDataBase.next()) {
        Text += "#fUI/UIToolTip.img/Item/Equip/Star/Star# #b名次:#r第 " + i + " 名#k#b     角色名: #r" + RankDataBase.getString("charName") + " #k#b   提交物品数:#r" + RankDataBase.getString("quantity") + "#b个#k "
        //Text += "~~~~~~~~~\r\n"
        i++;
    }
    cm.sendOk(Text);
