...
var starttime = "2016-1-10 21:10:00";
var endtime = "2016-1-12 21:20:00";
...
function action(mode, type, selection) {
	...
	if (hour != 21 || minute < 10 || minute > 30) { //这里是礼包开启时间21点10分至30分之间可以领取

        cm.sendOk("\t\t\t#r神秘商店#k\r\n\r\n#b庆祝点点火爆开启\r\n\r\n1月10日至1月12日每天晚上限量出售 (#r 2 #k#b)把FFN武器\r\n\r\n亲们务必注意好时间哦，商店开启时间有限#k\r\n\r\n非活动时间…… \r\n\r\n活动开始时间：#r" + starttime + "#k\r\n" + "活动结束时间：#r" + endtime);
        cm.dispose();
        return;
    } else {
