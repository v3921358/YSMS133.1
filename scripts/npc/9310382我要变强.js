...
function action(mode, type, selection) {
    ...
    if (cm.getMapId() == 180000001) {
		...
		//var selStr = "这里的功能能使你变得更加强大。\r\n\r\n";
            var selStr = "#e#n\t\t\t\t"+tz1+" 我要变强提升战力 "+tz1+"#n#k\r\n";
          	selStr += "" + tz12 + "" + tz13 + "" + tz14 + "" + tz12 + "" + tz13 + "" + tz14 + "" + tz12 + "" + tz13 + "" + tz14 + "" + tz12 + "" + tz13 + "" + tz14 + "" + tz12 + "" + tz13 + "" + tz14 + "" + tz12 + "" + tz13 + "" + tz14 + "" + tz12 + "\r\n"

		selStr += "#b#L17#"+tz20+" 图腾合成#l   #L99#"+tz20+" 武器破功#l   #L3#"+tz20+" 装备合成#l\r\n";

		selStr += "#b#L4#"+tz20+" 翅膀进阶#l   #L16#"+tz20+" 副本重置#l   #L6#"+tz20+" 点装强化#l\r\n";

		selStr += "#b#L19#"+tz20+" 增加血量#l   #L8#"+tz20+" 装备制作#l   #L9#"+tz20+" 装备还原#l\r\n";

		selStr += "#b#L14#"+tz20+" 宝藏仓库#l   #L11#"+tz20+" 伤害皮肤#l   #L12#"+tz20+" 职业副手#l\r\n\r\n";


		//selStr += "#b#L13#"+tz20+" 道具卷轴#l #L14#"+tz20+" 宝藏仓库#l \r\n\r\n";
		...
		//selStr += "#b#L1#"+tz20+" 蜡笔潜能#l #L2#"+tz20+" 武器破功#l #L3#"+tz20+" 装备合成#l\r\n";
		//selStr += "#b#L4#"+tz20+" 翅膀进阶#l #L5#"+tz20+" 粉笔强化#l #L6#"+tz20+" 点装强化#l\r\n";
		//selStr += "#r \t\t\t#L0#"+tz1+" 返回游戏拍卖菜单 "+tz1+"#l\r\n";
