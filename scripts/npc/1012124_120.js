...
function action(mode, type, selection) {
    ...
    if (cm.getMapId() == 180000001) {
		...
		var selStr = "#b#L0#"+tz9+" 杂货商店#l  #L1#"+tz9+" 双刀商店#l  #L2#"+tz9+" 飞镖商店#l\r\n";
		selStr += "#b#L3#"+tz9+" 特殊商店#l  #L4#"+tz9+" 外星商店#l  #L5#"+tz9+" 狮王商店#l\r\n";
		selStr += "#b#L6#"+tz9+" 金币商店#l  #L7#"+tz9+" 抵用商店#l  #L8#"+tz9+" 点卷礼包#l\r\n\r\n";

		selStr += "#b#L9#"+tz9+" 道具商店#l  #L10#"+tz9+" 卷轴商店#l  #L11#"+tz9+" 小饰品商店#l\r\n";
		selStr += "#b#L121#"+tz9+" 战士商店#l  #L122#"+tz9+" 法师商店#l  #L123#"+tz9+" 弓箭手商店#l\r\n";
		selStr += "#b#L124#"+tz9+" 飞侠商店#l  #L125#"+tz9+" 海盗商店#l  #L126#"+tz9+" 贝勒德专卖#l\r\n\r\n";
		...
		//selStr += "#r#L0#"+tz9+" 游  戏#b  [游戏杂货商店]#l #L5# [游戏宝库商店]#l\r\n";
	...
	cm.openNpc(9900003, 11);
	   ...
	   // cm.openNpc(9000290);
        ...
        case 121://战士装备商店
            cm.dispose();
            cm.openNpc(1012124, 121);
            break;
        case 122://法师装备商店
            cm.dispose();
            cm.openNpc(1012124, 122);
            break;
        case 123://弓手装备商店
            cm.dispose();
            cm.openNpc(1012124, 123);
            break;
        case 124://飞侠装备商店
            cm.dispose();
            cm.openNpc(1012124, 124);
            break;

        case 125://海盗装备商店
            cm.dispose();
            cm.openNpc(1012124, 125);
            break;
        case 126://其它装备商店
            cm.dispose();
	    //cm.sendOk("暂时未开放。")
            cm.openNpc(1012124, 126);
            break;
