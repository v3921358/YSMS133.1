...
function action(mode, type, selection) {
	...
	if(cm.getEventCount("皇陵") < 3){
	        zdhl = "#r已完成"+cm.getEventCount("皇陵")+"次任务#b";
	}else{
	        zdhl = "#g已完成任务#b";
	}
	if(cm.getEventCount("罗朱") < 3){
	...
	if(cm.getEventCount("月妙") < 1){
	        zdhl = "#r已完成"+cm.getEventCount("月妙")+"次任务#b";
	}else{
	        zdhl = "#g已完成任务#b";
	}
	...
	if (mode == -1) {
		...
		if (status == 0) { 
			...
			//selStr +="#L1#"+ttt6+" #r日常任务系统简介#l#k\r\n";
			//selStr +="您当前废弃组队任务积分：#r"+cm.getPlayerPoints()+"#k 点   \r\n\r\n";
			//selStr +="#L10##b"+ttt6+" [城镇]奖励集聚地    (#k目前状态： #r无次数限制#b)#l\r\n";
			//selStr +="#L2##b"+ttt6+" [日常]天天爱抽奖    (#k目前状态： "+ttcj+")#l\r\n";
			//selStr +="#L4#"+ttt6+" [日常]天天爱历练    (#k目前状态： "+ttll+")#l\r\n";
			//selStr +="#L5#"+ttt6+" [日常]天天爱养成    (#k目前状态： "+ttyc+")#l\r\n";
			selStr +="#L3##b"+ttt6+" [组队]废弃三人组    (#k每天10次： #r图腾#b)#l\r\n";
			selStr +="#L10##b"+ttt6+" [组队]玩具城组队    (#k每天三次： #r惊人正义卷#b)#l\r\n";
			selStr +="#L6#"+ttt6+" [组队]扫荡秦皇陵    (#k每天三次： #r正向混沌卷#b)#l\r\n";//目前状态： "+zdhl+"
			selStr +="#L7#"+ttt6+" [组队]拯救罗和朱    (#k每天三次： #r正向混沌卷#b)#l\r\n";//目前状态： "+zdlz+"
			selStr +="#L8#"+ttt6+" [组队]抢占海盗船    (#k每天三次： #r正向混沌卷#b)#l\r\n";//目前状态： "+zdhd+"
