...
function action(mode, type, selection) {
    ...
    if (status == 0) {//如果你有#b#t05152211##k 使用闪耀之星皇家整容券
        cm.sendSimple("你好，我是整形手术领域的艺术家#b#p9201148##k。如果你有#b#t05152211##k，我可以为你做脸部整形手术。怎么样？ 你想让自己的脸变得完美无瑕吗？\r\n#b#L0# 换脸(使用闪耀之星皇家整容券)#l");
    } else if (status == 1) {
        cm.sendYesNo("使用闪耀之星皇家整容券，可以随意更改脸型。但是请别担心，我的手术已经达到了艺术的境界。你真的要使用#b#t05152211##k，变换脸型吗？");
    } else if (status == 2) {
	    ...
	    //cm.gainItemPeriod(5152211,1,1);
        if (cm.setRandomAvatar(5152211, facetype) == 1) {
            cm.sendOk("好了,你的朋友们一定认不出你了!");
        } else {
            cm.sendOk("必须有闪耀之星皇家整容券，才能进行手术, 请在游戏宝库购买。");
        }
        cm.safeDispose();
    }
}