...
function action(mode, type, selection) {
    ...
    cm.removeAll(4001137);
		...
		if (cm.getBossLog("校园") < xygs){
                    ...
                    if (next) {
                        var em = cm.getEventManager("ZChaosPQ8");
                        if (em == null) {
                            cm.sendOk("此任务正在建设当中。");
                        } else {
		    ...
		    cm.setBossLog("校园");
                                ...
                                cm.sendOk("大运动会-枫之校园高手里面已经有人了，请稍等！");
                            }
                        }
                        cm.dispose();
                    } else {
