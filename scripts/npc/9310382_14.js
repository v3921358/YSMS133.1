...
function action(mode, type, selection) {
    ...
    if (status == 0) {
		...
		selStr += "#r#L12#"+z+" 点卷商店#l  #L6#"+z+" 自选发型#l  #L10#"+z+" 每日寻宝#l\r\n";
		selStr += "#L7#"+z+" 三倍经验#l  #L8#"+z+" 领取双爆#l  #L2#"+z+" 增加血量\r\n";
		selStr += "#L3#"+z+" 换取戒指#l  #L11#"+z+" 租借椅子#l  #L13#"+z+" 高级回收#l\r\n";
		selStr += "#L4#"+z+" BOSS重置#l  #L14#"+z+" 副本重置#l  #L17#"+z+" 钱庄返利#l\r\n";
