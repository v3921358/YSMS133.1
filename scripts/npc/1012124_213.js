...
function action(mode, type, selection) {
	if (mode == -1) {
		...
		if (status == 0) {
			...
			selStr +="#b您今天充值金额为：#r " + cm.getSevenDayPayLog(1) + " #b 元#k\r\n\r\n";////显示当天充值总金额\t#b您当前可用余额为：  #r" + cm.getRMB() + "
			//selStr +="#L110##r"+tz1+"  购买   #b[屌丝系列]#r   法弗纳武器#l#k\r\n";
			//selStr +="#L111##r"+tz1+"  购买   #b[屌丝系列]#r   布莱斯武器#l#k\r\n";
			//selStr +="#L112##r"+tz1+"  购买   #b[屌丝系列]#r   高级饰品#l#k\r\n";
			//selStr +="#L113##r"+tz1+"  购买   #b[贵族商场]#r   贵族道具#l#k\r\n";
			...
			selStr +="#L12#"+tz1+"  #b使用星币购买 #r#z3994417#礼包#k#l#k\r\n";
			...
			if (selection == 110) {
				typed=110;
				cm.sendYesNo("#b[屌丝系列] #r法弗纳武器比普通法弗纳武器属性要给力的多，但是价格很贵哟。您是否要查看购买?#k#n");
			} else if (selection == 2) {
				typed=2;
				...
				typed=12;
				cm.sendYesNo("#r温馨提示：您必须在今天充值100元才可以购买#k\r\n\r\n确定购买 #r超值蜡笔礼包#k 吗? 将会使用掉您 #r3000000#k 星币\r\n\r\n使用后将获得#v3994417# #v3994418# #v3994419# #v3994420# #v3994421# #v3994422#  x 各#r1#k 个.");

			} else if (selection == 112) {
				typed=112;
				cm.sendYesNo("仙器高级饰品 比普通饰品属性要给力的多，但是价格很贵哟。您是否要查看购买?");
			} else if (selection == 113) {
				typed=113;
				cm.sendYesNo("#b[贵族商场] #r极品道具 属性非常给力的，土豪贵族必备的象征，但是价格很贵哟。您是否要查看购买?#k#n");
			} else if (selection == 111) {
				typed=111;
				cm.sendYesNo("#b[屌丝系列] #r布莱斯武器比普通布莱斯武器属性要给力的多，但是价格很贵哟。您是否要查看购买?#k#n");
 		...
 		if (cm.getSevenDayPayLog(1).get(0) >= 100  &&  cm.getRMB() >= 3000000 && cm.getSpace(4) >= 6) {
			...
			//cm.worldSpouseMessage(0x20, "『星币商城』 : 恭喜 " + cm.getChar().getName() + " 在星币商城购买蜡笔礼包.");
			cm.dispose();
				} else {
			cm.sendOk("购买失败：#b    您今天充值金额为：#r " + cm.getSevenDayPayLog(1) + " #b元\r\n\r\n#b1). 您今天充值金额不足100元，请充值后再来购买\r\n2). 您星币不足，请获取足够的星币之后再来购买\r\n3). 背包栏位已满,请清理.");
			cm.dispose();
				}
           }
		}
