...
function action(mode, type, selection) {
    ...
    if (cm.getMapId() == 180000001) {
		...
		var selStr = "#e#g  "+epp+"现金极品商店。"+ epp +"#n#k\r\n\r\n";
          	selStr += "" + tz12 + "" + tz13 + "" + tz14 + "" + tz12 + "" + tz13 + "" + tz14 + "" + tz12 + "" + tz13 + "" + tz14 + "" + tz12 + "" + tz13 + "" + tz14 + "" + tz12 + "" + tz13 + "" + tz14 + "" + tz12 + "" + tz13 + "" + tz14 + "" + tz12 + "\r\n"
		
		    selStr += "#r#L1#"+yun1+" 埃苏装备#l      #L2#"+yun1+" 蜡笔礼包#l \r\n\r\n";
		    selStr += "#r#L3#"+yun1+" 暴君防具#l      #L4#"+yun1+" 极品卷轴#l \r\n\r\n";
        ...
        case 1://埃苏装备
            cm.dispose();
            cm.openNpc(9310382, 201);
            break;  
        case 2://蜡笔礼包
            cm.dispose();
            cm.openNpc(9310382, 202);
            break; 
        case 3://暴君防具
            cm.dispose();
            cm.openNpc(9310382, 203);
            break; 
        case 4://道具卷轴
            cm.dispose();
            cm.openNpc(9310382, 204);
            break;
        /*case 5://美容美发
            cm.dispose();
            cm.warp(100000104, 0);
