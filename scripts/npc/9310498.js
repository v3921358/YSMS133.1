...
function action(mode, type, selection) {
    ...
    if (status == 0) {
        ...
        var text = ""
        var i = 1;
        text += "#d#e最新抽中大奖信息：#k#n#r(2万星币抽1次,每抽一次返#r500点卷)#k\r\n\r\n-----------------------------------------------\r\n"
        ...
        text += "-----------------------------------------------\r\n#L0##b【星币抽奖】#l  #L1##d【奖品展览】#l #L2##r【次数领奖】#l#k \r\n\r\n \r\n"//可抽 #r" + parseInt(cm.getRMB() / needprice) + " #b次】#l
        cm.sendSimple(text);
        ...
        if (selection == 0) {
		    ...
		    cm.setBossLog("累计明星抽奖", 1);
                    if (nx) {
                        ...
                        cm.worldSpouseMessage(0x23,  "『终极大奖』 :  恭喜" + cm.getChar().getName() + ",运气爆表抽中 100,000 点券。");
                        ...
                        cm.worldSpouseMessage(0x23, "『终极大奖』 :  恭喜" + cm.getChar().getName() + ",运气爆表抽中100,000 抵用券。");
                        cm.sendOk("恭喜您从幸运抽奖中获得了 #b100,000 点卷抵用券#k.");
                        cm.safeDispose();
                    } else {
                        if (InsertData) {
                            var insert = cm.getConnection().prepareStatement("INSERT INTO Activity0512 (id,itemid,charid,charName,time) VALUES(?,?,?,?,?)"); // 载入数据
