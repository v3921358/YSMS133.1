...
function action(mode, type, selection) {
	if (mode == -1) {
		...
		if (status == 0) {
			...
			cm.worldSpouseMessage(0x20, "『军事新闻』 : 恭喜士兵 " + cm.getChar().getName() + " 经过不断的努力终于成功晋级为[中等兵]全属性+5");
			cm.dispose();
                } else {
			...
			cm.sendOk("恭喜您晋级成功.");
			cm.getMap().startMapEffect("恭喜玩家 "+cm.getChar().getName()+" 晋级军衔成功", 5120002);
			cm.worldSpouseMessage(0x20, "『军事新闻』 : 恭喜士兵 " + cm.getChar().getName() + " 经过不断的努力终于成功晋级为[高等兵]全属性+10");
			cm.dispose();
                } else {
			cm.sendOk("晋级失败：  #e#r勋章需要放在背包里升级\r\n\r\n#b需要#t4000286#：\t\t#r " + cm.itemQuantity(4000286) + " / 400 个r\n#b需要#t4310030#：\t\t#r" + cm.itemQuantity(4310030) + " / 200 个\r\n#b需要#t4310036#：\t\t#r" + cm.itemQuantity(4310036) + " / 400 个\r\n#b需要#t1142311#：\t#r" + cm.itemQuantity(1142311) + " / 1 个#k");
			cm.dispose();
				}
			} else if(typed==4){
			...
			cm.sendOk("恭喜您晋级成功.");
			cm.getMap().startMapEffect("恭喜玩家 "+cm.getChar().getName()+" 晋级军衔成功", 5120002);
			cm.worldSpouseMessage(0x20, "『军事新闻』 : 恭喜士兵 " + cm.getChar().getName() + " 经过不断的努力终于成功晋级为[军士长]全属性+15");
			cm.dispose();
                } else {
			cm.sendOk("晋级失败： - #e#r勋章需要放在背包里升级\r\n\r\n#b需要#t4000286#：\t\t#r " + cm.itemQuantity(4000286) + " / 800 个\r\n#b需要#t4310030#：\t\t#r" + cm.itemQuantity(4310030) + " / 320 个\r\n#b需要#t4310036#：\t\t#r" + cm.itemQuantity(4310036) + " / 320 个\r\n#b需要游戏币：\t\t #r    2000W\t\t\r\n#b需要#t1142312#：\t#r"+ cm.itemQuantity(1142312) + " / 1 个#k\r\n");
			cm.dispose();
			...
			cm.sendOk("恭喜您晋级成功.");
			cm.getMap().startMapEffect("恭喜玩家 "+cm.getChar().getName()+" 晋级军衔成功", 5120002);
			cm.worldSpouseMessage(0x20, "『军事新闻』 : 恭喜士兵 " + cm.getChar().getName() + " 经过不断的努力终于成功晋级为[准尉]全属性+20");
			cm.dispose();
                } else {
			cm.sendOk("晋级失败：  #e#r勋章需要放在背包里升级\r\n\r\n#b需要#t4000286#：\t\t#r " + cm.itemQuantity(4000286) + " / 1600 个\r\n#b需要#t4310030#：\t\t#r" + cm.itemQuantity(4310030) + " / 640 个\r\n#b需要#t4310036#：\t\t#r" + cm.itemQuantity(4310036) + " / 640 个\r\n#b需要游戏币：\t\t #r    4000W\t\t\r\n#b需要#t1142313#：\t#r"+ cm.itemQuantity(1142313) + " / 1 个#k\r\n");
			cm.dispose();
			...
			cm.sendOk("恭喜您晋级成功.");
			cm.getMap().startMapEffect("恭喜玩家 "+cm.getChar().getName()+" 晋级军衔成功", 5120002);
			cm.worldSpouseMessage(0x20, "『军事新闻』 : 恭喜士兵 " + cm.getChar().getName() + " 经过不断的努力终于成功晋级为[少尉]全属性+30");
			cm.dispose();
                } else {
			cm.sendOk("晋级失败：  #e#r勋章需要放在背包里升级\r\n\r\n#b需要#t4000286#：\t\t#r " + cm.itemQuantity(4000286) + " / 3200  个\r\n#b需要#t4310030#：\t\t#r" + cm.itemQuantity(4310030) +" / 1280 个\r\n#b需要#t4310036#：\t\t#r" +cm.itemQuantity(4310036)+" / 1280 个\r\n#b需要游戏币：\t\t #r    8000W\t\t\r\n#b需要#t1142314#：\t#r"+cm.itemQuantity(1142314) + " / 1 个#k\r\n#k");
			cm.dispose();
			...
			cm.sendOk("恭喜您晋级成功.");
			cm.getMap().startMapEffect("恭喜玩家 "+cm.getChar().getName()+" 晋级军衔成功", 5120002);
			cm.worldSpouseMessage(0x20, "『军事新闻』 : 恭喜士兵 " + cm.getChar().getName() + " 经过不断的努力终于成功晋级为[中尉]全属性+35");
			cm.dispose();
                } else {
			cm.sendOk("晋级失败：  #e#r勋章需要放在背包里升级\r\n\r\n#b需要#t4000286#：\t\t#r " + cm.itemQuantity(4000286) + " / 6400 个\r\n#b需要#t4310030#：\t\t#r" + cm.itemQuantity(4310030) +" / 1920 个\r\n#b需要#t4310036#：\t\t#r" +cm.itemQuantity(4310036)+ " / 1920 个\r\n#b需要游戏币：\t\t #r    1E6000W\t\t\r\n#b需要#t1142315#：\t#r"+cm.itemQuantity(1142315)+" / 1 个#k\r\n#k");
			cm.dispose();
			...
			cm.sendOk("恭喜您晋级成功.");
			cm.getMap().startMapEffect("恭喜玩家 "+cm.getChar().getName()+" 晋级军衔成功", 5120002);
			cm.worldSpouseMessage(0x20, "『军事新闻』 : 恭喜士兵 " + cm.getChar().getName() + " 经过不断的努力终于成功晋级为[上尉]全属性+40");
			cm.dispose();
                } else {
			cm.sendOk("晋级失败：  #e#r勋章需要放在背包里升级\r\n\r\n#b需要#t4000286#：\t\t#r " + cm.itemQuantity(4000286) + " / 8800 个\r\n#b需要#t4310030#：\t\t#r" + cm.itemQuantity(4310030) +" / 3840 个\r\n#b需要#t4310036#：\t\t#r" +cm.itemQuantity(4310036)+ " / 3840 个\r\n#b需要游戏币：\t\t #r    3E2000W\t\t\r\n#b需要#t1142316#：\t#r"+cm.itemQuantity(1142316)+" / 1 个#k\r\n#k");
			cm.dispose();
			...
			cm.sendOk("恭喜您晋级成功.");
			cm.getMap().startMapEffect("恭喜玩家 "+cm.getChar().getName()+" 晋级军衔成功", 5120002);
			cm.worldSpouseMessage(0x20, "『军事新闻』 : 恭喜士兵 " + cm.getChar().getName() + " 经过不断的努力终于成功晋级为[少校]全属性+50★★");
			cm.worldSpouseMessage(0x20, "『军事新闻』 : 恭喜士兵 " + cm.getChar().getName() + " 经过不断的努力终于成功晋级为[少校]全属性+50★★");
			cm.dispose();
                } else {
			cm.sendOk("晋级失败：  #e#r勋章需要放在背包里升级\r\n#g等级需要达到200级\r\n#b需要#t4310091#：\t\t#r " + cm.itemQuantity(4310091) + " / 4800 个\r\n#b需要#t4310030#：\t\t#r" + cm.itemQuantity(4310030) + " / 7680 个\r\n#b需要#t4310036#：\t\t#r" + cm.itemQuantity(4310036) + " / 7680 个\r\n#b需要#t4000313#：\t\t#r" + cm.itemQuantity(4000313) + " / 60 个\r\n#b需要#t4033356#：\t\t#r" + cm.itemQuantity(4033356) + " / 20 个\r\n#b需要#t4000082#：\t\t#r" + cm.itemQuantity(4000082) + " / 200 个\r\n#b需要游戏币：\t\t #r    6E\t\t\r\n#b需要#t1142317#：\t#r" + cm.itemQuantity(1142317) + " / 1 个#k\r\n\r\n#k");
			...
			cm.sendOk("恭喜您晋级成功.");
			cm.getMap().startMapEffect("恭喜玩家 "+cm.getChar().getName()+" 晋级军衔成功", 5120002);
			cm.worldSpouseMessage(0x20, "『军事新闻』 : 恭喜士兵 " + cm.getChar().getName() + " 经过不断的努力终于成功晋级为[中校]全属性+60★★★");
			cm.worldSpouseMessage(0x20, "『军事新闻』 : 恭喜士兵 " + cm.getChar().getName() + " 经过不断的努力终于成功晋级为[中校]全属性+60★★★");
			cm.worldSpouseMessage(0x20, "『军事新闻』 : 恭喜士兵 " + cm.getChar().getName() + " 经过不断的努力终于成功晋级为[中校]全属性+60★★★");
			cm.dispose();
                } else {
			...
			cm.sendOk("恭喜您晋级成功.");
			cm.getMap().startMapEffect("恭喜玩家 "+cm.getChar().getName()+" 晋级军衔成功", 5120002);
			cm.worldSpouseMessage(0x20, "『军事新闻』 : 恭喜士兵 " + cm.getChar().getName() + " 经过不断的努力终于成功晋级为[上校]全属性+70★★★");
			cm.worldSpouseMessage(0x20, "『军事新闻』 : 恭喜士兵 " + cm.getChar().getName() + " 经过不断的努力终于成功晋级为[上校]全属性+70★★★");
			cm.worldSpouseMessage(0x20, "『军事新闻』 : 恭喜士兵 " + cm.getChar().getName() + " 经过不断的努力终于成功晋级为[上校]全属性+70★★★");
			cm.dispose();
                } else {
			cm.sendOk("晋级失败：  - #e#r勋章需要放在背包里升级\r\n#g等级需要达到230级\r\n#b需要#t4310091#：\t\t#r " + cm.itemQuantity(4310091) + " / 6800 个\r\n#b需要#t4310030#：\t\t#r" + cm.itemQuantity(4310030) + " / 9680 个\r\n#b需要#t4310036#：\t\t#r" + cm.itemQuantity(4310036) + " / 9680 个\r\n#b需要#t4000313#：\t\t#r" + cm.itemQuantity(4000313) +" / 120 个\r\n#b需要#t4033356#：\t\t#r" + cm.itemQuantity(4033356) + " / 60 个\r\n#b需要#t4000082#：\t\t#r" + cm.itemQuantity(4000082) + " / 600 个\r\n#b需要游戏币：\t\t #r    8E\t\t\r\n#b需要#t1142319#：\t#r" + cm.itemQuantity(1142319) + " / 1 个#k#k");
			cm.dispose();
				}
			} else if(typed==12){
			...
			cm.sendOk("恭喜您晋级成功.");
			cm.getMap().startMapEffect("恭喜玩家 "+cm.getChar().getName()+" 晋级军衔成功", 5120002);
			cm.worldSpouseMessage(0x20, "『军事新闻』 : 恭喜士兵 " + cm.getChar().getName() + " 经过不断的努力终于成功晋级为[团长]全属性+100★★★★★");
			cm.worldSpouseMessage(0x20, "『军事新闻』 : 恭喜士兵 " + cm.getChar().getName() + " 经过不断的努力终于成功晋级为[团长]全属性+100★★★★★");
			cm.worldSpouseMessage(0x20, "『军事新闻』 : 恭喜士兵 " + cm.getChar().getName() + " 经过不断的努力终于成功晋级为[团长]全属性+100★★★★★");
			cm.worldSpouseMessage(0x20, "『军事新闻』 : 恭喜士兵 " + cm.getChar().getName() + " 经过不断的努力终于成功晋级为[团长]全属性+100★★★★★");
			cm.worldSpouseMessage(0x20, "『军事新闻』 : 恭喜士兵 " + cm.getChar().getName() + " 经过不断的努力终于成功晋级为[团长]全属性+100★★★★★");
