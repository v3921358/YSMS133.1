...
status--;
if (status == 0) {
	cm.sendSimpleS("\t\t\t#b>>> #e#d欢迎使用超值理财#n#b <<<#k\r\n" + tz1+ "" + tz1+ "" + tz1+ "" + tz1+ "" + tz1+ "" + tz1+ "" + tz1+ "" + tz1+ "" + tz1+ "" + tz1+ "" + tz1+ "" + tz1+ "" + tz1+ "" + tz1+ "" + tz1+ "" + tz1+ "" + tz1+ "" + tz1+ "" + tz1+ "" + tz1+ "" + tz1+ "" + tz1+ "" + tz1+ "" + tz1+ "" + tz1+ "" + tz1+ "" + tz1+ "#k\r\n\r\n#b您当前的现金点数为： #r"+cm.getRMB()+" #b元  您已经领取： #r"+cm.getBossLog("返利次数", 1) +" #b天#k\r\n\r\n    办理 #r30#k 天理财后可以在我这里领取相对应的福利哟。接下来的 #r20#k 天您可以在我这里领取#e#r不同的现金点#n#k，如果中间没有领取，损失将会是您自己的，请记住一定要按时领取，总共返利 #r290#k 元现金点。\r\n\r\n#k\r\n#r#L3#"+tz8+" 260元办理高级理财一月权#l\r\n\r\n#L4#" + tz1+ "" + tz1+ "" + tz1+ "" + tz1+ "" + tz1+ "" + tz1+ "" + tz1+ "" + tz1+ "" + tz1+ "#b点击返回上一页#k" + tz1+ "" + tz1+ "" + tz1+ "" + tz1+ "" + tz1+ "" + tz1+ "" + tz1+ "" + tz1+ "" + tz1+ "#l\r\n" ,2);//#L3#" + tz1+ "" + tz1+ "" + tz1+ "" + tz1+ "" + tz1+ "" + tz1+ "" + tz1+ "" + tz1+ "" + tz1+ "#b点击返回主菜单#k" + tz1+ "" + tz1+ "" + tz1+ "" + tz1+ "" + tz1+ "" + tz1+ "" + tz1+ "" + tz1+ "" + tz1+ "#l\r\n"
	} else if (status == 1) {
if (selection == 1) {
	typed=1;
