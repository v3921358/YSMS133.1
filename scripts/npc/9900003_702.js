...
function action(mode, type, selection) {
    ...
    if (status == 0) {
        cm.sendYesNo("你如果拥有300个#r#z4310091##k,可以在我这里抽奖,我包包里面有各职业100-140级装备，这个就要完全靠您的运气了。是否想要试试手气，看您能获得什么?");
    } else if (status == 1) {
          if (cm.haveItem(4310091, 300) == false) {
		cm.sendOk("你没有300个#v4310091##z4310091#");
		cm.dispose();
	   ...
	   cm.gainItem(4310091,-300); //减少1个使用的这个道具
