...
function action(mode, type, selection) {
	...
	cm.removeAll(4001260);
		...
		//if (cm.getEventCount("海盗1") < 3){
		if (cm.checkPartyEventCount("海盗,3")){
		//if (setPartyEventCount("海盗")){
			...
			//}
        		...
        		cm.dispose();
        		cm.sendOk("只有在1,2,3频道才可以参加[日常]抢占海盗船任务。");
	}
    }
}