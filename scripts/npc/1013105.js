...
var chance4 = Math.floor(Math.random() * 30 + 30);
...
function action(mode, type, selection) {
    ...
    if (cm.getMapId() == 180000001) {
        ...
        var selStr = "      #d当前服务器时间: #r" + hour + " #b点 #r" + minute + " #b分\r\n\r\n         #e#r疯狂挤奶活动暂未开启\r\n\r\n#r     活动将在每小时35分-38分开始#n\r\n\r\n#b开启活动后请疯狂点击我。这样您将随机获得一些点卷奖励。#k\r\n\r\n";
        ...
        switch (selection) {
        case 1:
            cm.sendOk("         #r活动将在每小时35分-38分开始#n\r\n\r\n#b开启活动后请疯狂点击我。这样您将随机获得一些点卷奖励。#k");
            cm.dispose();
            break;
        case 2:
            if ((minute >= 35 && minute <= 38)) {
                cm.gainNX(1, chance4);
                cm.sendOk("你挤出 #r" + chance4 + "#k 点点卷");
                cm.worldSpouseMessage(0x25, "『疯狂挤奶』 : 恭喜 " + cm.getChar().getName() + " 在市场 8 洞门口奶牛挤出 " + chance4 + " 点点卷.");//【活动翻倍】
	         //cm.worldSpouseMessage(0x20, "『【活动翻倍】疯狂挤奶』 : 恭喜 " + cm.getChar().getName() + " 在市场 8 洞门口奶牛挤出 " + chance4 + " 点卷.");//【活动翻倍】
                cm.dispose();
            } else {
