...
function action(mode, type, selection) {
    ...
    if (cm.getMapId() == 180000001) {
		...
		selStr += "#b#L10#"+yun1+" 家族业务#l #L2#"+yun1+" 爆率查询#l #L3#"+yun1+" 清理背包#l\r\n";
		selStr += "#b#L4#"+yun1+" 宠物进化#l #L5#"+yun1+" 美容美发#l #L6#"+yun1+" 银行管理#l\r\n";

		selStr += "#b#L7#"+yun1+" 管理雇佣#l #L8#"+yun1+" 活跃查询#l #L20#"+yun1+" 官方认证#l\r\n\r\n";

		//selStr += "#b#L10#"+yun1+" 家族业务#l #L11#"+yun1+" 重置副本#l #L12#"+yun1+" 猜拳游戏#l\r\n\t\r\n";

         selStr += "" + tz12 + "" + tz13 + "" + tz14 + "" + tz12 + "" + tz13 + "" + tz14 + "" + tz12 + "" + tz13 + "" + tz14 + "" + tz12 + "" + tz13 + "" + tz14 + "" + tz12 + "" + tz13 + "" + tz14 + "" + tz12 + "" + tz13 + "" + tz14 + "" + tz12 + "\r\n"

		selStr += " \t\t\t\t#b#L0#" + tz1+ " 返回菜单" + tz1+ "#l\r\n";
