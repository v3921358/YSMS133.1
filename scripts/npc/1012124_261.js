...
function action(mode, type, selection) {
    ...
    if (status == 0) {
        var selStr = "#e#b亲爱的#r#h ##k#b您好 \t#k#b当前可用芒果 #r" + cm.getPlayerPoints() + " #k#b个 \r\n\r\n请选择您希望购买的技能册：#k#e#n";
        for (var i = 0; i < itemList.length; i++) {
            selStr += "\r\n#L" + i + "##i" + itemList[i][0] + ":# #b#t" + itemList[i][0] + "##k #b需要 #r" + itemList[i][1] + " #k#b芒果#k#l";
        }
        ...
        if (item != null) {
            selectedItem = item[0];
            selectedCost = item[1];
            cm.sendYesNo("您是否购买#i" + selectedItem + ":# #b#t" + selectedItem + "##k 需要 #r" + selectedCost + "#k 芒果\r\n附加 500万 冒险币？");
        } else {
            cm.sendOk("出现错误...");
            cm.dispose();
        }
		...
		cm.gainPlayerPoints(-selectedCost);
            ...
            cm.sendOk("您没有那么多芒果或冒险币。\r\n\r\n购买#i" + selectedItem + ":# #b#t" + selectedItem + "##k \r\n需要 #r" + selectedCost + "#k 芒果 附加 500万 冒险币。");
        }
        cm.dispose();
    }
}