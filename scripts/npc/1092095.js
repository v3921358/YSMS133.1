...
var chance4 = Math.floor(Math.random() * 30 + 10);
    ...
    if (cm.getMapId() == 180000001) {
        ...
        case 2:
            if ((minute >= 30 && minute <= 33)) {
                ...
                cm.worldSpouseMessage(0x26, "『疯狂挤奶』 : 恭喜 " + cm.getChar().getName() + " 在市场 5 洞门口奶牛挤出 " + chance4 + " 点点卷.");//【活动翻倍】
	         //cm.worldSpouseMessage(0x20, "『【活动翻倍】疯狂挤奶』 : 恭喜 " + cm.getChar().getName() + " 在市场 5 洞门口奶牛挤出 " + chance4 + " 点卷.");//【活动翻倍】
                cm.dispose();
            } else {
