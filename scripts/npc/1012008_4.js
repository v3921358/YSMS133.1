...
function action(mode, type, selection) {
    if (mode == -1) {
        ...
        if (status == 0) {
            ...
            add += "" + xxx + "-当前下注押金:#b<#e#r 现金点赌博 #n#b>#b<#e#r " + cost + " 现金点#n#b >#k\r\n "; //cm.getPlayer().player.GetMoney()
            add += "" + xxx + "-当前您拥有现金点：" + cm.getRMB() + ".#k\r\n";
            add += "#L0#" + ttt + "-[#r加注#k]#l\r\n\r\n";
            ...
            if (selection == 0) {
                cm.sendOk("#b成功加注#r2现金点#b,请点确定后查看.");
                cost = cost + 2
                status = -1;
            } else if (selection == 1) {
                var add = "#b<#e#r 现金点赌博 #n#b>\r\n\r\n";
                add += "" + ttt + "-您选择的是[#r赔率1:1#b].\r\n";
                add += "" + ttt + "-您的押注为[#r" + cost + "现金点#b].\r\n";
                add += "" + ttt + "-如果胜利将获取[#r除本金外" + cost * 1 + "现金点#b]的奖励.\r\n";
                ...
                add += "" + ttt + "-您的押注为[#r" + cost + "现金点#b].\r\n";
                add += "" + ttt + "-如果胜利将获取[#r除本金外" + cost * 2 + "现金点#b]的奖励.\r\n";
                add += "" + ttt + "-点击[#r是#b]开始赌博,点击[#r不是#b]放弃赌博.";
                cm.sendYesNo(add);
                jilv = 2;
                xx = 0;
                ...
                add += "" + ttt + "-您的押注为[#r" + cost + "现金点#b].\r\n";
                add += "" + ttt + "-如果胜利将获取[#r除本金外" + cost * 3 + "现金点#b]的奖励.\r\n";
                add += "" + ttt + "-点击[#r是#b]开始赌博,点击[#r不是#b]放弃赌博.";
                cm.sendYesNo(add);
                jilv = 3;
                xx = 0;
			...
			//jiaru = GetRandomNum(0, jilv);
                        ...
                        if (jiaru == 2) {
                            costa = cost * jilv
                            cm.gainRMB(cost);
                            //cm.getC().getChannelServer().broadcastPacket(Packages.tools.MaplePacketCreator.serverNotice(0x19, cm.getC().getChannel(), "[博彩公告]" + " : 恭喜玩家：" + cm.getPlayer().getName() + " 在现金点博彩中赢得" + costa + "现金点。"));
