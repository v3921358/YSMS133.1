...
var onlineTime = Array(30,60,120,360,480,720,888,1000,1200); //填写时间，单位:分钟,即180分钟和480分钟可以领取一次
var mPoints = Array(1000,2000, 3000, 5000,8000, 10000, 20000, 30000, 40000);  //填写抵用卷，用逗号分隔，对应上面的分钟数
...
function action(mode, type, selection) {
	...
	if (status == 0) {
		var text = "你好，欢迎来到抵用券领取中心，如果你满足条件，就可以领取以下抵用券奖励。#r（此活动维持7天）#k\r\n";
