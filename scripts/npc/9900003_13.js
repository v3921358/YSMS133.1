...
var selects;
var BossList = Array(
        Array("#k#n[简单] 1-5频道挑战闹钟！", 220080000),
        Array("[简单] 1-5频道挑战暴力熊、心疤狮王！", 551030100),
        Array("[简单] 1-5频道挑战-阿卡伊勒祭坛!", 272030000),
        Array("[简单] 1频道挑战女王-艾菲尼娅!", 300030300),
        Array("[简单] 1-5频道挑战-千年树精王遗迹Ⅱ）", 541020800),
        Array("[简单] 2-4频道挑战-狮子王!", 211070000),
	...
	Array("[女皇]     1频道女皇 - 希纳斯的庭院!）", 271040000),
       // Array("[泰坦级] 强化钻机,弱小勿进(New~)", 703020000),
        ...
        Array("#k#r[超难] 2频道和3频道  - 三核贝勒德", 863000100),
        Array("[超难] 4频道和5频道 - 暴君麦格纳斯", 401072000)
	//Array("[超难] 4频道和5频道 - 黑色天堂终极斯乌", 350020120)
        )
