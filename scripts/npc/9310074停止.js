...
function action(mode, type, selection) {
    ...
    if (status == 0) {
    //var selStr = "#b"+tz20+"亲爱的"+tz20+" #r#h ##k"+tz20+" 您好 \r\n";
		 var selStr = "#d您当前点券： #r"+cm.getNX(1)+"#k #d点#k\t#d当前现金： #r" + cm.getRMB() + "#k #d点#k\r\n#e#d请选择：(#r请看好购买哦.点了就买啦!#k):\r\n#n#k";
		selStr += "#g======================#k点卷区域#g====================#k\r\n";
		selStr += "#b#L0#"+tz20+"戒指"+tz20+"#l	    #L2#"+tz20+"帽子"+tz20+"#l       #L4#"+tz20+"披风"+tz20+"\r\n";
		selStr += "#L6##b"+tz20+"裤裙"+tz20+"#l	    #L7#"+tz20+"上衣"+tz20+"#l       #L5#"+tz20+"其它"+tz20+"#l\r\n";
		selStr += "#L8##b"+tz20+"手套"+tz20+"#l	    #L9#"+tz20+"套装"+tz20+"#l       #L1#"+tz20+"鞋子"+tz20+"#l\r\n";
		selStr += "#L10##b"+tz20+"武器"+tz20+"#l        #L14#"+tz20+"椅子"+tz20+"#l\r\n\r\n";// #L12#稀有宠物#l\t#L13#"+tz20+"双倍"+tz20+"#l \t  
		selStr += "#g======================#k现金区域#g====================#k\r\n";
		selStr += "#L100#"+tz+"#r极品椅子#l    #L101#"+tz+"#r真系武器#l     #L102#"+tz+"#r150防具#l\r\n";
		selStr += "#L105#"+tz+"#r极品卷轴#l    #L104#"+tz+"#r强化礼包#l     #L103#"+tz+"#r150武器#l\r\n";

		//selStr += "#L17##r"+tz20+"装备"+tz20+"#l		#L19#"+tz20+"礼包"+tz20+"#l \t   #L20#"+tz20+"消耗"+tz20+"#l\r\n\r\n";
