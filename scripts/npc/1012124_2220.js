...
function action(mode, type, selection) {
    ...
    if (cm.getMapId() == 180000001) {
		...
		var selStr = "#e#g  "+epp+"这里都是公告福利活动栏"+ epp +"#n#k\r\n\r\n";
        selStr += "" + tz12 + "" + tz13 + "" + tz14 + "" + tz12 + "" + tz13 + "" + tz14 + "" + tz12 + "" + tz13 + "" + tz14 + "" + tz12 + "" + tz13 + "" + tz14 + "" + tz12 + "" + tz13 + "" + tz14 + "" + tz12 + "" + tz13 + "" + tz14 + "" + tz12 + "\r\n"
		
		selStr += "#r#L1#"+yun1+" 开服首次充值奖励#l \r\n";
		//selStr += "#r#L4#"+yun1+" 春节币店#l #L5#"+yun1+" 美容美发#l #L6#"+yun1+" 银行管理#l\r\n";

		//selStr += "#r#L7#"+yun1+" 管理雇佣#l #L8#"+yun1+" 活跃查询#l #L9#"+yun1+" 猜拳游戏#l\r\n\r\n";
