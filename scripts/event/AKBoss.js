...
var itemList=Array(
	...
	Array(1022232, 400), //布莱克缤瞳印
	Array(1052527, 100), //布莱克缤大衣
	Array(1212072, 400), //布莱克缤双头杖
	Array(1232064, 400), //布莱克缤亡命剑
	Array(1242069, 400), //布莱克缤能量剑
	Array(1302070, 400), //布莱克缤单手剑
	Array(1312142, 400), //布莱克缤单手斧
	Array(1312100, 400), //布莱克缤单手钝器
	Array(1332214, 400), //布莱克缤短刀
	Array(1342079, 400), //布莱克缤双刀
	Array(1362081, 400), //布莱克缤手杖
	Array(1372168, 400), //布莱克缤短杖
	Array(1382199, 400), //布莱克缤长杖
	Array(1402185, 400), //布莱克缤双手剑
	Array(1412126, 400), //布莱克缤双手斧
	Array(1432158, 400), //布莱克缤长枪
	Array(1442209, 400), //布莱克缤长矛
	Array(1452196, 400), //布莱克缤弓
	Array(1462184, 400), //布莱克缤弩
	Array(1472205, 400), //布莱克缤拳套
	Array(1482159, 400), //布莱克缤指节
	Array(1492170, 400), //布莱克缤短枪
	Array(1522085, 400), //布莱克缤双弩枪
...
function setup(level, leaderid) {
	...
	var mapForMob = eim.getMapInstance(272030400);
	mapForMob.spawnMonsterOnGroundBelow(mob, new java.awt.Point(18, -181));
...
function playerEntry(eim, player) {
    ...
    player.dropMessage(6, "[阿卡伊勒] 进入到了挑战地图，请小心行事。");
    player.changeMap(map, map.getPortal(0));
}


function scheduledTimeout(eim) {
    eim.broadcastPlayerMsg(1, "[阿卡伊勒] 真遗憾！已超过限定挑战时间，本次挑战失败！别气馁，期待更加强大的您前来挑战~");
...
function playerRevive(eim, player) {
    var map = em.getMapFactory().getMap(272030300);
    if (map != null) {
        player.changeMap(map, map.getPortal(0));
    }
    eim.disposeIfPlayerBelow(100, 272030300);
...
function changedMap(eim, player, mapid) {
    ...
    player.dropMessage(6, "[阿卡伊勒] 已退出挑战。");
...
function allMonstersDead(eim) {
    if (em.getProperty("state").equals("1")) {
		...
		eim.broadcastPlayerMsg(6, "[阿卡伊勒] 10秒后开启宝箱，掷点时请勿进行其他操作，并且需要在10秒钟内做出需求选择，否则将会被强制下线。");
		var map = eim.getMapInstance(272030400);
		map.startMapEffect("[阿卡伊勒] 已通关，10秒后将开出宝箱。", 5120059);
	}
}
	...
	if ((count*1)>=1) {
		for (var i = 0; i < eim.getPlayerCount(); i++) {
			...
			for (var j = 0; j < eim.getPlayerCount(); j++) {
				var notice =  "[阿卡伊勒] 玩家 "+charName+" 掷出了 "+eim.getProperty("charid_"+charId)+"点";
				if ((eim.getProperty("charid_"+charId)*1)==0) {
					notice =  "[阿卡伊勒] 玩家 "+charName+" 放弃了掷点";
				}
...
function EndThisBattle(eim) {
	for (var i = 0; i < eim.getPlayerCount(); i++) {
        eim.getPlayers().get(i).dropMessage(1, "[阿卡伊勒] 挑战成功！");
    }
