...
function setup(eim, leaderid) {
    ...
    map.resetFully();
    eim.getMapFactory().getMap(702060000).killAllMonsters(false);
    var mob = em.getMonster(9601013);
    var modified = em.newMonsterStats();
    modified.setOHp(mob.getMobMaxHp() * 4000*3);
    modified.setOMp(mob.getMobMaxMp() * 9000);
    mob.setOverrideStats(modified);
    eim.registerMonster(mob);
    map.spawnMonsterOnGroundBelow(mob, new java.awt.Point(184,593));
	
	
	var mob1 = em.getMonster(9601014);
    var modified1 = em.newMonsterStats();
    modified1.setOHp(mob1.getMobMaxHp() * 4000*2.5);
    modified1.setOMp(mob1.getMobMaxMp() * 9000);
    mob1.setOverrideStats(modified1);
    eim.registerMonster(mob1);
    map.spawnMonsterOnGroundBelow(mob1, new java.awt.Point(-448,593));
