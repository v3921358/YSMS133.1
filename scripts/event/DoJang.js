...
var mobs = new Array(			// 层数、怪物ID、数量、加强倍数
										// 第一层		极速蜗牛
										new Array(1, 1, 100100, 10, 30000),		//Lv1 - 蜗牛 15
										new Array(1, 1, 100101, 10, 30000),		//Lv2 - 蓝蜗牛 20
										new Array(1, 1, 130101, 10, 24000),			//Lv5 - 红蜗牛 50
										new Array(1, 1, 4250000, 10, 30),			//Lv98 - 苔藓蜗牛 61000
										...
										new Array(2, 1, 2600201, 10, 3),			//Lv122 - 受挫的绿蘑菇 447770
										new Array(2, 1, 2600202, 10, 3),			//Lv122 - 花蘑菇 447770
										...
										// 第三层		能当柴用
										new Array(3, 1, 100005, 7, 1500),			//Lv4 - 木妖 35
										new Array(3, 1, 1110101, 7, 1500),			//Lv10 - 黑木妖 125
										new Array(3, 1, 1130100, 7, 1500),			//Lv12 - 斧木妖 175
										new Array(3, 1, 1140100, 7, 1500),			//Lv16 - 古木妖 275
										new Array(3, 1, 1140130, 7, 1500),			//Lv17 - 开心的古木妖 300
										new Array(3, 1, 2130100, 7, 1500),			//Lv14 - 黑斧木妖 225
										new Array(3, 1, 9300246, 7, 150),			//Lv62 - 苔藓木妖 6300
										new Array(3, 1, 9800052, 7, 3),			//Lv117 - 苔藓木妖 1485000

										// 第四层		奇怪的蘑菇你不要踩
										new Array(4, 1, 2600204, 10, 3),			//Lv122 - 蓝蘑菇 447770
										...
										// 第五层		放开那女蘑菇~
										new Array(5, 1, 2600206, 10, 6),			//Lv122 - 僵尸蘑菇 447770
										new Array(5, 1, 2600207, 10, 6),			//Lv122 - 生气的僵尸蘑菇 447770
										new Array(5, 2, 2600208, 5, 6),				//Lv122 - 蘑菇王 2725000
										new Array(5, 2, 9400205, 5, 75),			//Lv90 - 蓝蘑菇王 200000
										new Array(5, 1, 9500441, 5, 3),			//Lv120 - 情侣蘑菇 1605000
										new Array(5, 2, 9300436, 5, 750),			//Lv66 - 僵尸蘑菇王 20000
										new Array(5, 1, 9400829, 5, 300),			//Lv73 - 黑暗苔藓蘑菇 13000
										...
										//第七层		水灵灵的世界
										new Array(7, 1, 100006, 3, 3000),				//Lv7 - 绿水灵 80
										new Array(7, 1, 1210103, 3, 3000),			//Lv10 - 蓝水灵 125
										new Array(7, 1, 9300027, 3, 1500),			//Lv23 - 恶魔水灵 465
										new Array(7, 1, 7120103, 3, 6),			//Lv120 - 红水灵 105000
										new Array(7, 1, 7120104, 3, 6),			//Lv120 - 银水灵 105000
										new Array(7, 1, 7120105, 3, 6),			//Lv120 - 金水灵 105000
										new Array(7, 1, 9391000, 3, 6),			//Lv135 - 街道水灵 160000
										new Array(7, 1, 2600215, 3, 3),				//Lv126 - 椰子树水灵 517049
										new Array(7, 1, 2600216, 3, 3),				//Lv126 - 紫贝壳水灵 517049
										new Array(7, 1, 2600217, 3, 3),				//Lv126 - 蓝色游泳圈水灵 517049
										new Array(7, 1, 2600218, 3, 3),				//Lv126 - 虾水灵 517049
										new Array(7, 1, 2600219, 3, 3),				//Lv126 - 飞鱼水灵 517049
										new Array(7, 1, 2600220, 3, 3),				//Lv126 - 海星章鱼水灵 517049
										new Array(7, 1, 2600221, 3, 3),				//Lv126 - 海螺章鱼水灵 517049
										new Array(7, 2, 2600222, 3, 6),				//Lv126 - 船长黑水灵 2950000

										//第八层		狂鳄之灾
										new Array(8, 1, 8210000, 7, 3),			//Lv115 - 看门鳄鱼兵 95000
										new Array(8, 1, 9300297, 7, 1.5),			//Lv125 - 红色鳄鱼兵 9500000
										new Array(8, 1, 9300234, 7, 150),			//Lv32 - 鳄鱼 1100
										new Array(8, 1, 9300235, 7, 150),			//Lv52 - 黑鳄鱼 3400
										new Array(8, 1, 9300114, 7, 150),			//Lv63 - 老海盗可怕的鳄鱼宠物 8040
										new Array(8, 1, 9300120, 7, 150),			//Lv65 - 老海盗可恶的鳄鱼宠物 9000
										new Array(8, 1, 9300123, 7, 150),			//Lv65 - 老海盗的鳄鱼宠物 9000
										new Array(8, 1, 2600322, 7, 3),			//Lv139 - 鳄鳄 959867
										new Array(8, 2, 6220000, 3, 3000),			//Lv25 - 多尔 5250

										//第九层		海贼王来袭
										new Array(9, 1, 8141000, 5, 15),			//Lv119 - 大海贼 103000
										new Array(9, 1, 8141100, 5, 15),			//Lv122 - 大海贼王 109000
										new Array(9, 1, 8145008, 10, 15),			//Lv134 - 大海贼熊 155000
										new Array(9, 2, 8220003, 2, 15),				//Lv145 - 大海兽 2100000
										new Array(9, 2, 2600326, 2, 6),				//Lv139 - 老海盗 4500000

										//第十层		暗杀团的阴谋
										new Array(10, 1, 9390813, 5, 9),			//Lv157 - 雪狼 300000
										new Array(10, 1, 9390814, 5, 9),			//Lv158 - 黑暗者 310000
										new Array(10, 1, 9390818, 5, 9),			//Lv160 - 暗杀团刺客 660000
										new Array(10, 1, 9390819, 5, 9),			//Lv162 - 暗杀团战斗者 700000
										new Array(10, 1, 9390820, 5, 9),			//Lv163 - 暗杀团恶魔训练师 720000
										new Array(10, 1, 9390821, 5, 9),			//Lv162 - 爆眼小恶魔 700000
										new Array(10, 1, 9390822, 2, 9),			//Lv165 - 暗杀团头头卡纳斯 1175000
										new Array(10, 1, 9390833, 5, 9),			//Lv160 - 可疑的蒙面人 660000
										...
										//第十三层	喜羊羊与灰太狼
										new Array(13, 1, 9600003, 5, 900),			//Lv45 - 绵羊 2400
										new Array(13, 1, 9600004, 5, 900),			//Lv50 - 山羊 3000
										new Array(13, 1, 9600005, 5, 900),			//Lv55 - 黑山羊 4000
										new Array(13, 1, 9600008, 5, 900),			//Lv57 - 黑绵羊 4600
										new Array(13, 1, 2600014, 5, 15),			//Lv104 - 恶魔绵羊 217920
										new Array(13, 1, 9810001, 5, 30),			//Lv114 - 邪恶绵羊 93000
										new Array(13, 2, 9300481, 2, 3),			//Lv117 - 绵羊酋长 4950000
										new Array(13, 2, 9300624, 2, 15),			//Lv115 - 血牙副队长 525000

										//第十四层	“是死是活，就在今天”——《人狼大战》

										new Array(14, 2, 2500821, 2, 3),			//Lv90 - 恶魔血牙 16666667
										new Array(14, 2, 2500241, 2, 3),			//Lv90 - 恶魔血牙 16666667
										new Array(14, 2, 2500701, 2, 3),			//Lv90 - 恶魔铁心 16666667
										new Array(14, 2, 2500850, 5, 3),			//Lv50 - 恶魔血牙 5000000
										new Array(14, 2, 8870003, 5, 3),			//Lv115 - 血牙 525000

										//第十五层	石头记
										new Array(15, 1, 2600209, 10, 15),			//Lv124 - 石头人 479546
										new Array(15, 1, 2600210, 10, 15),			//Lv124 - 黑石头人 479546
										new Array(15, 1, 2600211, 10, 15),			//Lv124 - 混种石头人 479546
										new Array(15, 1, 2600212, 10, 15),			//Lv124 - 冰混种石头人 479546
										new Array(15, 1, 2600213, 10, 15),			//Lv124 - 火混种石头人 479546
										...
										//第十七层	叱咤武林
										new Array(17, 3, 9600025, 3, 5),			//Lv150 - 武林妖僧 80000000
										new Array(17, 2, 9600024, 10, 125),			//Lv125 - 银人 115000

										////////////////////////////////////////////////////////

										//第十九层	早起的鸟儿有虫吃
										new Array(19, 1, 2600609, 5, 15),			//Lv164 - 闹钟啾啾 2746619
										new Array(19, 1, 8200000, 5, 150),			//Lv136 - 时间之眼 165000
										new Array(19, 2, 9800071, 5, 90),			//Lv153 - 时间门神 3900000
										new Array(19, 3, 9300513, 3, 30),			//Lv125 - 帕普拉图斯的座钟 8000000

										//第二十层	冰冻的一切不及一颗冰冻的心
										new Array(20, 1, 2600907, 5, 6),			//Lv140 - 冰冻的不安 7400000
										new Array(20, 1, 2600906, 5, 6),			//Lv140 - 冰冻的愤怒 7400000
										new Array(20, 1, 2600908, 5, 6),			//Lv140 - 冰冻的空虚 7400000
										new Array(20, 1, 2600909, 5, 6),			//Lv140 - 冰冻的孤独 7400000
										new Array(20, 1, 2600905, 5, 6),			//Lv140 - 冰冻的恐怖 7400000
										...
										//第二十三层 大战植物和僵尸……
										new Array(23, 1, 9390642, 8, 30),			//Lv150 - 黑色佩蒂特 1410000
										new Array(23, 1, 9390644, 8, 30),			//Lv150 - 红色佩蒂特 1410000
										new Array(23, 1, 9390646, 8, 30),			//Lv150 - 诅咒佩蒂特 1410000
										new Array(23, 2, 8147003, 8, 75),			//Lv155 - 佛罗拉 560000
										new Array(23, 2, 8147004, 8, 75),			//Lv156 - 黑暗佛罗拉 580000
										new Array(23, 2, 9800088, 8, 3),			//Lv176 - 矿山僵尸 7350000
										...
										//第二十七层 追忆之路
										new Array(27, 1, 2600706, 8, 75),			//Lv176 - 后悔的祭司 4189194
										new Array(27, 1, 2600709, 8, 75),			//Lv176 - 后悔的守护队长 4189194
										new Array(27, 1, 2600702, 8, 75),			//Lv173 - 追忆的神官 3799785
										new Array(27, 1, 2600708, 8, 75),			//Lv176 - 后悔的守护兵 4189194
										new Array(27, 1, 2600707, 8, 75),			//Lv176 - 后悔的神官 4189194
										new Array(27, 1, 2600703, 8, 75),			//Lv173 - 追忆的守护兵 3799785
...
new Array(1, 4001713, 10000),		//定居金10万金钱			
new Array(1, 4001714, 5000)		//定居金100万金钱					
);

var dropItemsAdvanced = 2430069; // 祖母绿箱子
