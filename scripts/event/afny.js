...
function allMonstersDead(eim) {
		...
		map.spawnAutoDrop(item[randitem],chr.getPosition());
                map.broadcastMessage(Packages.tools.MaplePacketCreator.serverNotice(5, "[●ω●提示]：恭喜，干掉进阶血腥女王，获得了" + yp[randyp] + "张邮票和稀有点装奖励"));
            }
        }
    }
