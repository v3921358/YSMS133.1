...
public class PlayerCommand {
    ...
    public static class Fh extends CommandExecute {
        ...
        @Override
        public int execute(MapleClient c, String[] splitted) {
            int reliveCount = c.getChannelServer().getReliveCount();
            int reliveCost = c.getChannelServer().getReliveCost();
...
//            c.getPlayer().changeMap(to, to.getPortal(0));
	 ...
	 * 穿戴手镯
     */
    public static class 穿戴手镯 extends CommandExecute {

        @Override
        public int execute(MapleClient c, String[] splitted) {
            if (splitted.length < 2) {
                c.getPlayer().dropMessage(6, "用法: @穿戴手镯 [手镯在在装备拦的位置]");
                return 0;
            }
            ...
            if (GameConstants.is爆莉萌天使(c.getPlayer().getJob())) {
                short src = (short) Integer.parseInt(splitted[1]);
                Item toUse = c.getPlayer().getInventory(MapleInventoryType.EQUIP).getItem(src);
                if (toUse == null || toUse.getQuantity() < 1 || !ItemConstants.is萝莉副手(toUse.getItemId())) {
                    c.getPlayer().dropMessage(6, "穿戴错误，装备栏的第[" + src + "]个道具为空或该道具不是天使副手装备。");
                    return 0;
                }
                MapleInventoryManipulator.equip(c, src, (short) -10);
                return 1;
            } else {
                c.getPlayer().dropMessage(6, "此命令只对天使萝莉开放。");
                return 0;
            }
        }
    }
	 ...
	 * 取下宝盒
     */
    public static class 取下手镯 extends CommandExecute {
        ...
        public int execute(MapleClient c, String[] splitted) {
            if (GameConstants.is爆莉萌天使(c.getPlayer().getJob())) {
                ...
                if (toUse == null || c.getPlayer().getInventory(MapleInventoryType.EQUIP).isFull()) {
                    c.getPlayer().dropMessage(6, "取下手镯错误，副武器位置道具信为空或装备栏已满。");
                    return 0;
                }
                MapleInventoryManipulator.unequip(c, (byte) -10,
	 ...
	 * 穿戴狂龙副手
     */
    public static class 穿戴狂龙副手 extends CommandExecute {

        @Override
        public int execute(MapleClient c, String[] splitted) {
            if (splitted.length < 2) {
                c.getPlayer().dropMessage(6, "用法: @穿戴狂龙副手 [狂龙副手在装备拦的位置]");
                return 0;
            }
            if (c.getPlayer().getLevel() < 10) {
                c.getPlayer().dropMessage(5, "等级达到10级才可以使用此命令.");
            ...
            if (GameConstants.is狂龙战士(c.getPlayer().getJob())) {
                short src = (short) Integer.parseInt(splitted[1]);
                Item toUse = c.getPlayer().getInventory(MapleInventoryType.EQUIP).getItem(src);
                if (toUse == null || toUse.getQuantity() < 1 || !ItemConstants.is狂龙副手(toUse.getItemId())) {
                    c.getPlayer().dropMessage(6, "穿戴错误，装备栏的第[" + src + "]个道具为空或该道具不是狂龙副手装备。");
                    return 0;
                }
                MapleInventoryManipulator.equip(c, src, (short) -10);
                return 1;
            } else {
                c.getPlayer().dropMessage(6, "此命令只对狂龙战士开放。");
                return 0;
            }
        }
    }
	 ...
	 * 取下狂龙副手
     */
    public static class 取下狂龙副手 extends CommandExecute {
        ...
        public int execute(MapleClient c, String[] splitted) {
            if (GameConstants.is狂龙战士(c.getPlayer().getJob())) {
                Item toUse = c.getPlayer().getInventory(MapleInventoryType.EQUIPPED).getItem((short) -10);
                if (toUse == null || c.getPlayer().getInventory(MapleInventoryType.EQUIP).isFull()) {
                    c.getPlayer().dropMessage(6, "取下狂龙副手错误，副武器位置道具为空或装备栏已满。");
                    return 0;
                }
                MapleInventoryManipulator.unequip(c, (byte) -10,
                        c.getPlayer().getInventory(MapleInventoryType.EQUIP).getNextFreeSlot());
        ...
        public int execute(MapleClient c, String[] splitted) {
            ...
            if (GameConstants.is龙的传人(c.getPlayer().getJob())) {
                ...
                if (toUse == null || toUse.getQuantity() < 1 || !ItemConstants.is龙传宝盒(toUse.getItemId())) {
                    c.getPlayer().dropMessage(6, "穿戴错误，装备栏的第[" + src + "]个道具信息为空或该道具不是宝盒装备。");
                    return 0;
                }
                MapleInventoryManipulator.equip(c, src, (short) -10);
                return 1;
    ...
    public static class 取下宝盒 extends CommandExecute {
        ...
        public int execute(MapleClient c, String[] splitted) {
            if (GameConstants.is龙的传人(c.getPlayer().getJob())) {
                ...
                c.getPlayer().dropMessage(6, "此命令只对龙的传人职业开放。");
                return 0;
            }
        }
    }
	 ...
	 * 穿戴恶魔盾牌
     */
    public static class 穿戴恶魔盾牌 extends CommandExecute {

        @Override
        public int execute(MapleClient c, String[] splitted) {
            if (splitted.length < 2) {
                c.getPlayer().dropMessage(6, "用法: @穿戴恶魔盾牌 [恶魔盾牌在装备拦的位置]");
                return 0;
            }
            if (c.getPlayer().getLevel() < 10) {
                c.getPlayer().dropMessage(5, "等级达到10级才可以使用此命令.");
            ...
            if (GameConstants.is恶魔职业(c.getPlayer().getJob())) {
                short src = (short) Integer.parseInt(splitted[1]);
                Item toUse = c.getPlayer().getInventory(MapleInventoryType.EQUIP).getItem(src);
                if (toUse == null || toUse.getQuantity() < 1 || !ItemConstants.is恶魔副手(toUse.getItemId())) {
                    c.getPlayer().dropMessage(6, "穿戴错误，装备栏的第 " + src + " 个道具的道具信息为空，或者该道具不是恶魔副手装备。");
                    return 0;
                }
                MapleInventoryManipulator.equip(c, src, (short) -10);
                return 1;
	 ...
	 * 取下恶魔盾牌
     */
    public static class 取下恶魔盾牌 extends CommandExecute {
        ...
        public int execute(MapleClient c, String[] splitted) {
            if (GameConstants.is恶魔职业(c.getPlayer().getJob())) {
                Item toUse = c.getPlayer().getInventory(MapleInventoryType.EQUIPPED).getItem((short) -10);
                if (toUse == null || c.getPlayer().getInventory(MapleInventoryType.EQUIP).isFull()) {
                    c.getPlayer().dropMessage(6, "取下恶魔盾牌错误，副武器位置道具信息为空，或者装备栏已满。");
                    return 0;
                }
                MapleInventoryManipulator.unequip(c, (byte) -10,
                        c.getPlayer().getInventory(MapleInventoryType.EQUIP).getNextFreeSlot());
	 ...
	 * 穿戴尖兵副手
     */
    public static class 穿戴尖兵副手 extends CommandExecute {

        @Override
        public int execute(MapleClient c, String[] splitted) {
            if (splitted.length < 2) {
                c.getPlayer().dropMessage(6, "用法: @穿戴尖兵副手 [尖兵副手在装备拦的位置]");
                return 0;
            }
            if (c.getPlayer().getLevel() < 10) {
                c.getPlayer().dropMessage(5, "等级达到10级才可以使用此命令。");
            ...
            if (GameConstants.is尖兵(c.getPlayer().getJob())) {
                short src = (short) Integer.parseInt(splitted[1]);
                Item toUse = c.getPlayer().getInventory(MapleInventoryType.EQUIP).getItem(src);
                if (toUse == null || toUse.getQuantity() < 1 || !ItemConstants.is尖兵副手(toUse.getItemId())) {
                    c.getPlayer().dropMessage(6, "穿戴错误，装备栏的第[" + src + "]个道具的道具为空或该道具不是尖兵副手装备。");
                    return 0;
                }
                MapleInventoryManipulator.equip(c, src, (short) -10);
                return 1;
            } else {
                c.getPlayer().dropMessage(6, "此命令只对尖兵职业开放。");
                return 0;
            }
        }
    }
	 ...
	 * 取下尖兵副手
     */
    public static class 取下尖兵副手 extends CommandExecute {
        ...
        public int execute(MapleClient c, String[] splitted) {
            if (GameConstants.is尖兵(c.getPlayer().getJob())) {
                Item toUse = c.getPlayer().getInventory(MapleInventoryType.EQUIPPED).getItem((short) -10);
                if (toUse == null || c.getPlayer().getInventory(MapleInventoryType.EQUIP).isFull()) {
                    c.getPlayer().dropMessage(6, "取下尖兵副手错误，副武器位置道具信息为空或装备栏已满。");
                    return 0;
                }
                MapleInventoryManipulator.unequip(c, (byte) -10,
                        c.getPlayer().getInventory(MapleInventoryType.EQUIP).getNextFreeSlot());
    ...
    public static class Help extends CommandExecute {
        ...
        public int execute(MapleClient c, String[] splitted) {
            ...
            c.getPlayer().dropMessage(5, "@穿戴手镯 < 宝盒在装备拦的位置 > 注意: 此功能只对天使开放");
            c.getPlayer().dropMessage(5, "@取下手镯 注意: 此功能只对天使开放");
            c.getPlayer().dropMessage(5, "@穿戴狂龙副手 < 宝盒在装备拦的位置 > 注意: 此功能只对狂龙开放");
            c.getPlayer().dropMessage(5, "@取下狂龙副手 注意: 此功能只对狂龙开放");
            c.getPlayer().dropMessage(5, "@穿戴宝盒 < 宝盒在装备拦的位置 > 注意: 此功能只对龙的传人开放");
            c.getPlayer().dropMessage(5, "@取下宝盒 注意: 此功能只对龙的传人开放");
            c.getPlayer().dropMessage(5, "@穿戴恶魔盾牌 < 恶魔盾牌在装备拦的位置 > 注意: 此功能只对恶魔职业开放");
            c.getPlayer().dropMessage(5, "@取下恶魔盾牌 注意: 此功能只对恶魔职业开放");
            c.getPlayer().dropMessage(5, "@穿戴尖兵副手 < 尖兵副手在装备拦的位置 > 注意: 此功能只对恶魔职业开放");
            c.getPlayer().dropMessage(5, "@取下尖兵副手 注意: 此功能只对尖兵开放");
            c.getPlayer().dropMessage(5, "@爆率 < 查看当前爆率 >");
            /*
