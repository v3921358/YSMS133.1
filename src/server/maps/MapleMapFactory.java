...
public class MapleMapFactory {
    ...
    private MapleDataProvider source = MapleDataProviderFactory.getDataProvider(new File(System.getProperty("wzpath") + "/Map.wz"));
    private MapleData nameData = MapleDataProviderFactory.getDataProvider(new File(System.getProperty("wzpath") + "/String.wz")).getData("Map.img");
        ...
        if (map == null) {
            ...
            try {
                ...
                if (!map.isTown() && map.getAllMonster().size() > 0 && map.getAllMonster().get(0).getStats().getLevel() >= 30) {
                    MapleMonster mob = monsters.get(Randomizer.rand(0, monsters.size() - 1));
                ...
                map.setPersonalShop(mapid > 910000000 && mapid <= 910000022);
