...
public class MapScriptMethods {
        ...
        switch (onFirstUserEnter.fromString(scriptName)) {
            ...
            default: {
                if (ServerProperties.ShowPacket()) {
                    System.out.println("地图触发: 未找到 " + scriptName + ", 类型: onFirstUserEnter - 地图ID " + c.getPlayer().getMapId());
                }
                FileoutputUtil.log(FileoutputUtil.ScriptEx_Log, "地图触发: 未找到 " + scriptName + ", 类型: onFirstUserEnter - 地图ID " + c.getPlayer().getMapId());
                break;
            }
        }
    }
    ...
    public static void startScript_User(final MapleClient c, String scriptName) {
        ...
        switch (onUserEnter.fromString(scriptName)) {
            ...
            case merTutorSleep00: {
                ...
                sDate.put(SkillFactory.getSkill(20021181), new SkillEntry((byte) -1, (byte) 0, -1));
                sDate.put(SkillFactory.getSkill(20021166), new SkillEntry((byte) -1, (byte) 0, -1));
                sDate.put(SkillFactory.getSkill(双弩.精灵恢复), new SkillEntry((byte) 1, (byte) 1, -1));
                sDate.put(SkillFactory.getSkill(双弩.精灵的祝福), new SkillEntry((byte) 1, (byte) 1, -1));
                sDate.put(SkillFactory.getSkill(双弩.优雅移动), new SkillEntry((byte) 1, (byte) 1, -1));
                sDate.put(SkillFactory.getSkill(双弩.王者资格), new SkillEntry((byte) 1, (byte) 1, -1));
            ...
            case merTutorDrecotion00: {
                ...
                Map<Skill, SkillEntry> sDate = new HashMap<>();
                sDate.put(SkillFactory.getSkill(20021181), new SkillEntry((byte) 1, (byte) 1, -1));
                sDate.put(SkillFactory.getSkill(20021166), new SkillEntry((byte) 1, (byte) 1, -1));
                c.getPlayer().changeSkillsLevel(sDate);
                break;
            }
            ...
            case aswan_stageEff: {
                ...
                switch ((c.getPlayer().getMapId() % 1000) / 100) {
                    case 1:
                    case 2:
                        c.getSession().write(UIPacket.MapEff("aswan/stageEff/stage"));
                        c.getSession().write(UIPacket.MapEff("aswan/stageEff/number/" + ((c.getPlayer().getMapId() % 1000) / 100)));
                        break;
                    case 3:
                        c.getSession().write(UIPacket.MapEff("aswan/stageEff/final"));
                        break;
                }
                break;
            }
            ...
            case ds_tuto_2_before: {
                ...
                EventTimer.getInstance().schedule(new Runnable() {
                    ...
                    public void run() {
                        ...
                        Map<Skill, SkillEntry> sDate = new HashMap<>();
                        sDate.put(SkillFactory.getSkill(30011170), new SkillEntry((byte) 1, (byte) 1, -1));
                        sDate.put(SkillFactory.getSkill(30011169), new SkillEntry((byte) 1, (byte) 1, -1));
                        sDate.put(SkillFactory.getSkill(30011168), new SkillEntry((byte) 1, (byte) 1, -1));
                        sDate.put(SkillFactory.getSkill(30011167), new SkillEntry((byte) 1, (byte) 1, -1));
                        sDate.put(SkillFactory.getSkill(30010166), new SkillEntry((byte) 1, (byte) 1, -1));
                        c.getPlayer().changeSkillsLevel(sDate);
                    }
                }, 5500);
                break;
            ...
            case ds_tuto_0_0: {
                ...
                c.getSession().write(UIPacket.IntroDisableUI(true));
                Map<Skill, SkillEntry> sDate = new HashMap<>();
                sDate.put(SkillFactory.getSkill(恶魔猎手.恶魔之翼), new SkillEntry((byte) 1, (byte) 1, -1));
                sDate.put(SkillFactory.getSkill(恶魔猎手.恶魔跳跃), new SkillEntry((byte) 1, (byte) 1, -1));
                sDate.put(SkillFactory.getSkill(恶魔猎手.死亡诅咒), new SkillEntry((byte) 1, (byte) 1, -1));
                sDate.put(SkillFactory.getSkill(恶魔猎手.恶魔之血), new SkillEntry((byte) 1, (byte) 1, -1));
                c.getPlayer().changeSkillsLevel(sDate);
                c.getSession().write(UIPacket.getDirectionInfo(3, 0));
            ...
            case iceCave: {
                Map<Skill, SkillEntry> sDate = new HashMap<>();
                sDate.put(SkillFactory.getSkill(战神.教程技能1), new SkillEntry((byte) -1, (byte) 0, -1));
                sDate.put(SkillFactory.getSkill(战神.教程技能2), new SkillEntry((byte) -1, (byte) 0, -1));
                sDate.put(SkillFactory.getSkill(战神.教程技能3), new SkillEntry((byte) -1, (byte) 0, -1));
                sDate.put(SkillFactory.getSkill(战神.教程技能4), new SkillEntry((byte) -1, (byte) 0, -1));
                sDate.put(SkillFactory.getSkill(战神.教程技能5), new SkillEntry((byte) -1, (byte) 0, -1));
                c.getPlayer().changeSkillsLevel(sDate);
            ...
            default: {
                if (ServerProperties.ShowPacket()) {
                    System.out.println("地图触发: 未找到 " + scriptName + ", 类型: onUserEnter - 地图ID " + c.getPlayer().getMapId());
                }
                FileoutputUtil.log(FileoutputUtil.ScriptEx_Log, "地图触发: 未找到 " + scriptName + ", 类型: onUserEnter - 地图ID " + c.getPlayer().getMapId());
                break;
            }
        }
    }
    ...
    private static void sendDojoStart(MapleClient c, int stage) {
        c.getSession().write(MaplePacketCreator.environmentChange("Dojang/start", 0x05));
        c.getSession().write(MaplePacketCreator.environmentChange("dojang/start/stage", 0x0C));
        c.getSession().write(MaplePacketCreator.environmentChange("dojang/start/number/" + stage, 0x0C));
        if (stage == 1) {
