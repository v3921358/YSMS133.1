...
public class PredictCardFactory {
    ...
    private static PredictCardFactory instance = new PredictCardFactory();
    protected MapleDataProvider etcData = MapleDataProviderFactory.getDataProvider(new File(System.getProperty("wzpath") + "/Etc.wz"));
    protected Map<Integer, PredictCard> predictCard = new HashMap<>();
    protected Map<Integer, PredictCardComment> predictCardComment = new HashMap<>();
