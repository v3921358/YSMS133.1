...
public final class PokemonBattle {
    ...
    private static int WALK_TIME = 2000; //how fast monster movement should be
                    ...
                    public void run() {
                        ...
                        switch (turn[i]) {
                            ...
                            case ATTACK:
                                ...
                                final boolean extraEffects = battlers[i].getAbility() != PokemonAbility.SheerForce && battlers[i == 1 ? 0 : 1].getAbility() != PokemonAbility.ShieldDust && s != MonsterStatus.魔击无效;
                                int critChance = 20;
                                ...
                                final PokemonElement element = (speshul || Randomizer.nextInt(5) == 0) && s != MonsterStatus.封印 && battlers[i == 0 ? 1 : 0].getAbility() != PokemonAbility.Normalize && battlers[i].getElementSize() > 0 ? battlers[i].getElements()[(battlers[i].getElementSize() == 1 ? 0 : Randomizer.nextInt(battlers[i].getElementSize()))] : PokemonElement.None;
                                ...
                                EtcTimer.getInstance().schedule(new Runnable() {
                                    ...
                                    public void run() {
                                        ...
                                        if (battlers[i == 0 ? 1 : 0].getAbility() != PokemonAbility.NoGuard && battlers[i].getAbility() != PokemonAbility.NoGuard && battlers[i].getACC() < (Randomizer.nextInt(1 + battlers[i == 1 ? 0 : 1].getEVA()) * (s == MonsterStatus.恐慌 ? 2 : 1))) {
                                        ...
                                        if (atk == 0) { //defined as "contact"
                                            if (battlers[i].getCurrentStatus() == null && battlers[i == 0 ? 1 : 0].getAbility() == PokemonAbility.EffectSpore && Randomizer.nextInt(100) < 50) {
                                                ...
                                                final MonsterStatusEffect mse = new MonsterStatusEffect(stati, stati == MonsterStatus.持续伤害 ? (int) (battlers[i].calcHP() / 16) : 1, MonsterStatus.genericSkill(stati), null, false, 0);
                                                ...
                                                final MonsterStatus stati = MonsterStatus.持续伤害;
                                                ...
                                                final MonsterStatus stati = MonsterStatus.影网;
                                        ...
                                        if (extraEffects && basedamage > 1 && stat != null && battlers[i == 1 ? 0 : 1].getCurrentStatus() == null && battlers[i].getAbility() != PokemonAbility.Klutz && battlers[i == 1 ? 0 : 1].getItem() != HoldItem.Pheremone) {
                                            if (battlers[i].getAbility() != PokemonAbility.Klutz && battlers[i].getAbility() != PokemonAbility.Unnerve && battlers[i == 1 ? 0 : 1].getItem() == HoldItem.Pineapple) {
                                                ...
                                                if (battlers[i == 1 ? 0 : 1].getAbility() == PokemonAbility.Synchronize && battlers[i].getCurrentStatus() == null && battlers[i == 0 ? 1 : 0].getAbility() != PokemonAbility.Klutz && battlers[i].getItem() != HoldItem.Pheremone) {
                                                    battlers[i].setStatus(new MonsterStatusEffect(stat, stat == MonsterStatus.持续伤害 ? (int) (battlers[i].calcHP() / 16) : 1, MonsterStatus.genericSkill(stat), null, false, 0));
