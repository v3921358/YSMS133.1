...
public class MapleQuest implements Serializable {
    ...
    protected List<MapleQuestRequirement> startReqs = new LinkedList<>(); //开始任务需要的条件
    protected List<MapleQuestRequirement> completeReqs = new LinkedList<>(); //完成任务需要的条件
    protected List<MapleQuestAction> startActs = new LinkedList<>(); //开始任务的操作
    protected List<MapleQuestAction> completeActs = new LinkedList<>(); //完成任务的操作
    protected Map<String, List<Pair<String, Pair<String, Integer>>>> partyQuestInfo = new LinkedHashMap<>(); //组队任务 [rank, [more/less/equal, [property, value]]]
    protected Map<Integer, Integer> relevantMobs = new LinkedHashMap<>(); //完成任务需要杀的怪物和数量
    protected Map<Integer, Integer> questItems = new LinkedHashMap<>(); //完成任务需要的道具和数量
