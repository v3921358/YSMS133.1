...
public abstract class Timer {
    ...
    public ScheduledFuture<?> register(Runnable command, long period, long initialDelay) {
         ...
         */
        return ses.scheduleAtFixedRate(new LoggingSaveRunnable(command, file), initialDelay, period, TimeUnit.MILLISECONDS);
    }
    ...
    public ScheduledFuture<?> register(Runnable command, long period) {
        ...
        return ses.scheduleAtFixedRate(new LoggingSaveRunnable(command, file), 0, period, TimeUnit.MILLISECONDS);
    }
    ...
    public ScheduledFuture<?> schedule(Runnable command, long delay) {
         ...
         */
        return ses.schedule(new LoggingSaveRunnable(command, file), delay, TimeUnit.MILLISECONDS);
    }
    ...
    private static class LoggingSaveRunnable implements Runnable {
        ...
        public void run() {
            try {
                ...
                FileoutputUtil.outputFileError(file, t); //写出执行定时任务的错误信息
            }
        }
    }
