...
public class Item implements Comparable<Item>, Serializable {
    ...
    private long inventoryitemid = 0; //道具在SQL中的ID
    ...
    public Item copyWithQuantity(short quantitys) {
        Item ret = new Item(id, position, quantitys, flag, uniqueid);
        ret.pet = pet;
        ret.owner = owner;
        ret.sn = sn;
    ...
    public boolean hasSetOnlyId() {
        ...
        if (uniqueid > 0 || ii.isCash(id) || id / 1000000 != 1) {
            return false;
        }
        return equipOnlyId <= 0;
    }
