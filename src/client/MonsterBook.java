...
public final class MonsterBook implements Serializable {
    ...
    public void modifyBook(Equip eq) {
        ...
        eq.setOptential1((short) 0);
        eq.setOptential2((short) 0);
        eq.setOptential3((short) 0);
        if (currentSet > -1) {
            ...
            if (set != null) {
                for (int i = 0; i < set.right.size(); i++) {
                    if (i == 0) {
                        eq.setOptential1(set.right.get(i).shortValue());
                    } else if (i == 1) {
                        eq.setOptential2(set.right.get(i).shortValue());
                    } else if (i == 2) {
                        eq.setOptential3(set.right.get(i).shortValue());
                        break;
                    }
                }
            } else {
