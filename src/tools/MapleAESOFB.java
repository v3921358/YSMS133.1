...
//    }
     ...
     * @param pIv = old Iv
     */
    public static final void Morph(byte pValue, byte[] pIv) {
        byte input = pValue;
        byte tableInput = funnyBytes[input];
        pIv[0] += (byte) (funnyBytes[pIv[1]] - input);
        pIv[1] -= (byte) (pIv[2] ^ tableInput);
        pIv[2] ^= (byte) (funnyBytes[pIv[3]] + input);
