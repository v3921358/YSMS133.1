...
public class MessengerRankingWorker {
    ...
    private MapleCharacter[] rankingPlayer;
    private int[] rankingLove;
    ...
    public void updateRankFromDB() {
        ...
        try {
            ...
            if (maleId > 0) {
                System.err.println("更新聊天招待人气排行榜 男角色 - Id: " + StringUtil.getRightPaddedStr(String.valueOf(maleId), ' ', 6) + " 好感度: " + StringUtil.getRightPaddedStr(String.valueOf(malelove), ' ', 4) + " 名字: " + (malechr != null ? malechr.getName() : "????"));
            } else {
            ...
            if (femaleId > 0) {
                System.err.println("更新聊天招待人气排行榜 女角色 - Id: " + StringUtil.getRightPaddedStr(String.valueOf(femaleId), ' ', 6) + " 好感度: " + StringUtil.getRightPaddedStr(String.valueOf(femalelove), ' ', 4) + " 名字: " + (femalechr != null ? femalechr.getName() : "????"));
            } else {
                System.err.println("更新聊天招待人气排行榜 女角色 - 暂无信息... ");
            }
        } catch (SQLException se) {
            System.err.println("更新聊天招待人气排行榜失败.." + se);
        }
    }
