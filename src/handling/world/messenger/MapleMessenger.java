...
public class MapleMessenger implements Serializable {
    ...
    private MapleMessengerCharacter[] members; //聊天招待的信息
    private String[] silentLink; //难道是离线的玩家名字信息
    private int id; //聊天招待的工作ID
    private MessengerType type; //聊天招待的类型
    private boolean hide; //是否是GM创建的聊天室
