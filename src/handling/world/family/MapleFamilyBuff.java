...
public enum MapleFamilyBuff {
    ...
    public void setEffects() {
        ...
        switch (type) {
            case 2: //drop
                effects.add(new Pair<>(MapleBuffStat.DROP_RATE, effect));
                effects.add(new Pair<>(MapleBuffStat.MESO_RATE, effect));
                break;
            case 3: //exp
                effects.add(new Pair<>(MapleBuffStat.EXPRATE, effect));
                break;
            case 4: //both
                effects.add(new Pair<>(MapleBuffStat.EXPRATE, effect));
                effects.add(new Pair<>(MapleBuffStat.DROP_RATE, effect));
