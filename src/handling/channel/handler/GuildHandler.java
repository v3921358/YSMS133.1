...
public class GuildHandler {
    ...
    private static long nextPruneTime = System.currentTimeMillis() + 1 * 60 * 1000;
    ...
    public static void Guild(LittleEndianAccessor slea, MapleClient c) {
        ...
        switch (mode) {
            ...
            case 0x02://查看家族信息
                ...
                if (tmpguild != null) {
                    c.getSession().write(GuildPacket.ViewGuildInfo(tmpguild));
                }
                break;
            ...
            case 0x07: // 家族邀请  V.117.1修改
                ...
                if (mgr != null) {
                    ...
                    invited.put(name, new Pair<>(chr.getGuildId(), currentTime + (1 * 60 * 1000)));
                }
                break;
            case 0x36: // 接受家族邀请
                if (chr.getGuildId() > 0) {
            ...
            case 0x2D: {//家族搜索
                ...
                switch (type) {
                    case 0: {//搜索家族名:
                        ...
                        String ResguildName = slea.readMapleAsciiString();
                        String Patriarch = "找不到族长";
                        int Mean = 0;
                        for (Pair<Integer, MapleGuild> g : gui) {
                            if (g.getRight().getName().endsWith(ResguildName)) {
                        ...
                        c.getSession().write(GuildPacket.guildSearch_Results(Gui, Patriarch, Mean)); //取消创建家族
                        break;
                    }
                    case 1: {//按照搜索条件来搜索家族
