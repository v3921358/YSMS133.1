...
public class EventInstanceManager {
    ...
    public void monsterDrop(final MapleCharacter chr, final MapleMonster mob) {
        ...
        try {
            ...
            System.out.println("Event name: " + (em == null ? "null" : em.getName() + ".js") + ", Instance name : " + name + ", method Name : monsterDrop(解决方法：在event目录打开" + em.getName() + ".js脚本，在文件最后一行添加方括号内的代码 【function monsterDrop(eim, player, mob) {}】 即可解决。)\n" + ex);
